// Aplica a migration 108 (Curso "Igreja Simples" — Rainer & Geiger) via service role.
//
//   node scripts/apply-108-igreja-simples.mjs
//
// Lê o .sql como fonte da verdade: faz o parse do curso, das 10 aulas
...
const sql = readFileSync(new URL("../supabase/migrations/108_curso_igreja_simples.sql", import.meta.url), "utf8");

const CURSO = {
  slug: "igreja-simples",
  titulo: "Igreja Simples",
  descricao: (sql.match(/'igreja-simples',\s*'Igreja Simples',\s*'([\s\S]*?)',\s*'\/api\/og/) || [])[1],
