...
- "roteiro": de 1 a 5 slides (você escolhe o número pela regra acima). Com 2+, eles formam UMA mensagem contínua e coerente (cada texto conecta com o anterior e o seguinte). Cada slide:
    ...
    - "prompt": foto cinematográfica EM INGLÊS com LUZ DOURADA de nascer/pôr do sol, atmosférica, cheia de vida (golden hour, warm backlight, film grain). PESSOAS são bem-vindas SE estiverem DE COSTAS, em silhueta, multidão vista por trás, ou figuras distantes (ex.: "a crowd seen from behind facing a glowing city skyline at golden sunrise"). PROIBIDO: rosto em close, selfie, retrato, mãos em destaque, celulares, telas, letras/texto. Símbolos/natureza/luz também valem (torch, mountains, open road, rays of light).
