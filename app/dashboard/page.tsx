...
export default async function DashboardPage() {
  ...
  // Tudo que fica entre o campo de busca e a vitrine: atalhos, o que está
  // sendo lido e a estante de lidos. Vira variável porque o campo de busca
  // subiu pro topo (issue #149) e precisa esconder isto enquanto se busca —
