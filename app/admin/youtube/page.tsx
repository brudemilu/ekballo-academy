    ...
    <AdminShell current="youtube" session={session}>
      ...
      <div className="mb-6 rounded-2xl border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
        ...
        <p className="mt-2 text-xs">
          <strong>Limite técnico:</strong> o YouTube bloqueia IPs de datacenter
          (Vercel/AWS) com frequência. Em produção, pode falhar muitas vezes —
          é normal, não é defeito da ferramenta.
        </p>
      </div>
