...
const CAPAS: Record<string, CapaConfig> = {
  ...
  "cristao-inutil": {
    ...
    preLabel: "VIDA CRISTÃ · 10 AULAS",
    titulo: "Como se tornar\num cristão inútil",
  ...
  "quebrando-intimidacao": {
    ...
    preLabel: "AUTORIDADE ESPIRITUAL · 16 CAPÍTULOS",
    titulo: "Quebrando as Cadeias\nda Intimidação",
  ...
  "pastor-aprovado": {
    ...
    preLabel: "MINISTÉRIO PASTORAL · 10 CAPÍTULOS",
    titulo: "O Pastor\nAprovado",
