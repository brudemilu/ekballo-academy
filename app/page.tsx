...
// Rótulo em caixa-alta reutilizado (padrão editorial das seções)
function Eyebrow({ children, className = "text-laranja-600" }: { children: React.ReactNode; className?: string }) {
  return (
...
export default function Home() {
  return (
    <main className="min-h-screen bg-bege-50">
      {/* ============== NAV (barra fixa, superfície clara) ============== */}
      <header className="sticky top-0 z-50 border-b border-bege-200 bg-bege-50/85 backdrop-blur-md">
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <Logo />
          <div className="flex items-center gap-4">
            <Link href="/login" className="hidden text-sm font-medium text-bege-600 transition-colors hover:text-laranja-600 sm:inline">
              Entrar
            </Link>
            <Link
              href="/cadastro"
              className="rounded-full bg-laranja-500 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-laranja-500/25 transition hover:bg-laranja-600"
            >
              Comece agora
            </Link>
          </div>
      ...
      {/* ============== HERO (composição centrada + showcase) ============== */}
      <CursorGlow className="relative overflow-hidden bg-gradient-to-b from-laranja-50 via-bege-50 to-bege-100">
        {/* Floating decorative blobs */}
        <div aria-hidden className="absolute -right-40 top-10 h-96 w-96 animate-float-slow rounded-full bg-laranja-200/50 blur-3xl" />
        <div aria-hidden className="absolute -left-40 top-40 h-96 w-96 rounded-full bg-oliveira-200/40 blur-3xl" />

        <div className="relative mx-auto max-w-3xl px-6 pt-20 text-center sm:pt-28">
          <p className="mb-8 inline-flex items-center gap-2 rounded-full border border-laranja-200 bg-white/70 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-laranja-700 backdrop-blur animate-fade-in">
            <span className="inline-block h-1.5 w-1.5 animate-pulse-soft rounded-full bg-laranja-500" />
            Discipulado · Formação · Envio
          </p>
          <h1 className="font-serif text-5xl font-semibold leading-[1.02] tracking-tight text-bege-800 sm:text-6xl lg:text-7xl animate-fade-up">
            Famílias fortes.
            <br />
            <span className="shimmer-text">Discípulos maduros.</span>
          </h1>
          <p className="mx-auto mt-8 max-w-xl font-serif text-xl italic leading-relaxed text-bege-700 sm:text-2xl animate-fade-up [animation-delay:120ms]">
            Mais que encontros. Uma transformação. Na mesa somos formados pelo
            Espírito, somos enviados.
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row animate-fade-up [animation-delay:240ms]">
            <Link
              href="/cadastro"
            ...
            <Link
              href="/manifesto"
              className="inline-flex items-center gap-2 rounded-full border border-bege-300 bg-white/70 px-8 py-4 text-base font-medium text-bege-800 backdrop-blur transition hover:border-laranja-400 hover:bg-white hover:text-laranja-700"
            >
              Conhecer a mesa
            </Link>
          </div>
        ...
        {/* Showcase — imagem larga com badge flutuante */}
        <div className="relative mx-auto mt-16 max-w-5xl px-6">
          <div className="relative animate-fade-in [animation-delay:300ms]">
            <div aria-hidden className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-br from-laranja-300/30 via-bege-200/20 to-oliveira-300/30 blur-2xl" />
            <div className="img-vignette relative overflow-hidden rounded-[2rem] shadow-2xl shadow-bege-700/25">
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-6 left-4 max-w-[220px] rounded-2xl border border-bege-200 bg-white/95 p-4 shadow-xl shadow-bege-700/15 backdrop-blur-md sm:-bottom-8 sm:left-8 animate-fade-up [animation-delay:600ms]">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-laranja-600">esta semana</p>
              <p className="mt-1 font-serif text-lg font-semibold leading-tight text-bege-800">3 famílias começaram</p>
              <p className="text-xs text-bege-600">o curso âncora juntas</p>
            </div>
          </div>
        </div>

        {/* Mini-stats — faixa dividida */}
        <div className="relative mx-auto mt-24 max-w-3xl px-6 pb-24">
          <div className="grid grid-cols-3 divide-x divide-bege-300 rounded-3xl border border-bege-200 bg-white/60 py-8 backdrop-blur animate-fade-up [animation-delay:360ms]">
            <div className="px-2 text-center sm:px-6">
              <p className="font-serif text-3xl font-semibold text-laranja-600 sm:text-4xl">+200</p>
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-bege-500">discípulos na mesa</p>
            </div>
            <div className="px-2 text-center sm:px-6">
              <p className="font-serif text-3xl font-semibold text-laranja-600 sm:text-4xl">12</p>
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-bege-500">temáticas publicadas</p>
            </div>
            <div className="px-2 text-center sm:px-6">
              <p className="font-serif text-3xl font-semibold text-laranja-600 sm:text-4xl">7 anos</p>
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-bege-500">de jornada Ekballo</p>
            </div>
          </div>
        </div>
      </CursorGlow>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          <RevealOnScroll className="mx-auto mb-16 max-w-2xl text-center">
            <Eyebrow>Três passos da formação</Eyebrow>
            <h2 className="mt-4 font-serif text-4xl font-semibold leading-tight text-bege-800 sm:text-5xl">
              Mesa, Formação, Envio
            </h2>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <RevealOnScroll key={p.num} delay={(i + 1) as 1 | 2 | 3} as="article" className="lift flex flex-col overflow-hidden rounded-3xl border border-bege-200 bg-white shadow-sm shadow-bege-700/5">
                <div className="img-vignette relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute left-4 top-4 inline-flex items-center gap-2 rounded-full bg-white/95 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-bege-700 shadow-sm">
      ...
      <section className="bg-gradient-to-b from-bege-100 via-bege-100 to-bege-200/50">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <RevealOnScroll>
              <Eyebrow className="text-laranja-700">Como funciona</Eyebrow>
              <h2 className="mb-6 mt-4 font-serif text-4xl font-semibold leading-tight text-bege-800 sm:text-5xl">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-4 rounded-2xl border border-bege-200/70 bg-white/60 p-4">
            ...
            <RevealOnScroll delay={1}>
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-3xl border border-bege-200 bg-white shadow-2xl shadow-bege-700/15">
                  ...
                  <div className="space-y-5 p-7">
                    <div>
                      <p className="mb-1 text-xs font-semibold uppercase tracking-[0.14em] text-laranja-600">Mesa 03 · Reflexão</p>
                      <h4 className="font-serif text-xl font-semibold text-bege-800">
                        O que significa para você &ldquo;ser enviado&rdquo;?
                      </h4>
                    </div>
                    <div className="rounded-xl border border-bege-100 bg-bege-50/50 p-4 text-sm text-bege-700">
                    ...
                    <div className="rounded-xl border-l-4 border-oliveira-400 bg-oliveira-50/50 p-4">
                      <p className="mb-1 text-xs font-semibold uppercase tracking-[0.14em] text-oliveira-700">Devolutiva do líder</p>
                    ...
                    <div className="flex items-center justify-between text-xs text-bege-500">
                      ...
                      <span className="font-medium text-oliveira-600">● Sua jornada continua</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          <RevealOnScroll className="mx-auto mb-16 max-w-2xl text-center">
            <Eyebrow>Histórias da mesa</Eyebrow>
            <h2 className="mt-4 font-serif text-4xl font-semibold leading-tight text-bege-800 sm:text-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <RevealOnScroll key={i} delay={(i + 1) as 1 | 2 | 3 | 4} as="article" className="lift flex flex-col rounded-3xl border border-bege-200 bg-bege-50/40 p-6 shadow-sm shadow-bege-700/5">
                <svg viewBox="0 0 24 24" fill="currentColor" className="mb-4 h-7 w-7 text-laranja-200" aria-hidden>
                  <path d="M9.5 6C6.5 6 4 8.5 4 11.5V18h6v-6H7c0-1.7 1.3-3 3-3V6zm10 0c-3 0-5.5 2.5-5.5 5.5V18h6v-6h-3c0-1.7 1.3-3 3-3V6z" />
                </svg>
                <p className="flex-grow text-sm leading-relaxed text-bege-700">&ldquo;{d.texto}&rdquo;</p>
                <div className="mt-6 flex items-center gap-3 border-t border-bege-200 pt-4">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={d.avatar} alt={d.nome} className="h-11 w-11 rounded-full object-cover ring-2 ring-laranja-200" loading="lazy" />
                  <div>
      ...
      <section className="relative overflow-hidden bg-bege-100">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-12 lg:gap-16 lg:py-32">
          ...
          <RevealOnScroll delay={1} className="lg:col-span-7">
            <Eyebrow className="text-laranja-700">A voz pastoral · A história</Eyebrow>
            <h2 className="mb-8 mt-4 font-serif text-4xl font-semibold leading-tight text-bege-800 sm:text-5xl">
              Pr. Bruno Fernandes
            </h2>

            {/* Pull quote — primeiro parágrafo do texto na íntegra */}
            <blockquote className="mb-10 rounded-r-2xl border-l-4 border-laranja-500 bg-laranja-50/50 py-5 pl-6 pr-4 font-serif text-lg italic leading-relaxed text-bege-800 sm:text-xl">
            ...
            <div className="space-y-5 text-justify text-[15.5px] leading-relaxed text-bege-700 hyphens-auto">
              <p>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <Link
                href="/manifesto"
                className="inline-flex items-center gap-2 rounded-full border border-bege-300 bg-white px-6 py-3 text-sm font-semibold text-bege-700 transition hover:border-laranja-400 hover:text-laranja-600"
              >
                Ler o manifesto
              </Link>
            </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          <RevealOnScroll className="mx-auto mb-12 max-w-2xl text-center">
            <Eyebrow>A vida na mesa</Eyebrow>
            <h2 className="mt-4 font-serif text-4xl font-semibold leading-tight text-bege-800 sm:text-5xl">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[IMG_MESA_2, IMG_BIBLIA, IMG_FAMILIA].map((src, i) => (
              <RevealOnScroll key={i} delay={(i + 1) as 1 | 2 | 3} className="lift img-vignette overflow-hidden rounded-3xl">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={src}
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-laranja-500 via-laranja-600 to-laranja-700 text-white">
        ...
        <RevealOnScroll className="relative mx-auto max-w-3xl px-6 py-28 text-center lg:py-36">
          <p className="mb-5 text-xs font-semibold uppercase tracking-[0.24em] text-laranja-100">Comece hoje</p>
