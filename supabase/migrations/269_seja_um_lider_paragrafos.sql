-- Seja um Líder de Verdade — conserta a paragrafação e devolve os cabeçalhos.
--
-- Dois defeitos, mesma origem (scripts/casar-seja-um-lider.py, que casa o texto
-- limpo do rascunho com a paragrafação do PDF):
--
-- 1. O parágrafo terminava no meio da frase e o seguinte começava com o rabo da
--    frase anterior ("...apareceu agora mesmo na" / "televisão. — Que tal é
--    ele?"). Valia para o livro inteiro: 1.086 dos ~1.400 parágrafos abriam em
--    letra minúscula. Causa: o corte usava o índice do TOKEN normalizado como
--    se fosse o índice da PALAVRA, mas nem toda palavra vira token (o travessão
--    de diálogo "—" some na normalização) — e cada descartada empurrava o corte
--    uma palavra, acumulando ao longo do capítulo. O cap. 12 abre em diálogo,
--    por isso era ali que o estrago aparecia logo na primeira tela.
--
-- 2. Os títulos de seção ("A AUTORIDADE INTERIOR") e os subtítulos ("Descobrir
--    a Nós Mesmos") não existiam no texto. O rascunho os marcava com ## e ###, e
--    a função paragrafos() descartava toda linha iniciada por "#"; pelo PDF eles
--    também não voltavam, porque suas palavras aparecem no corpo do capítulo e
--    o _ja_existe os tomava por repetição. São 169 cabeçalhos nos 13 capítulos.
--
-- Correções no script: tokens() devolve a posição crua de cada token; a âncora
-- do parágrafo recua as palavras da abertura que não casaram; costurar() fecha o
-- que a virada de página do PDF deixara aberto; e paragrafos() preserva os
-- cabeçalhos (só tira o marcador). Quem devolve o destaque na tela é o
-- AulaConteudo.tsx, que lê a CAIXA ALTA como seção e a Caixa de Título como
-- subseção.
--
-- Fora os cabeçalhos, o texto é o mesmo que já estava no banco — conferido
-- palavra a palavra —, inclusive a figura do cap. 7, que veio da migration 230 e
-- só existe no banco. Os capítulos não têm áudio de leitura, então não há
-- narração para ressincronizar.
...
"O seu programa envolve sérios riscos, mas ele mostra, também, grande inteligência, compreensão da história, e uma força de vontade que quase não se vê mais nos estadistas ocidentais, e, sem dúvida, é inexistente na Washington atual... "O papa, obviamente, não espera retirada de exércitos, colapso de alianças, levantamento da Cortina de Ferro. Não obstante, pensa em modificar os termos em que os poloneses e outros povos da Europa Oriental são governados, bem como forçar as autoridades comunistas a fazerem algumas concessões.
...
Antes de continuar a discutir esse tema, vamos definir o termo liderança. Se os que tentam analisar a liderança se equivocam quanto à sua tarefa, como disse W. C. H. Prentice, isso acontece em parte por não compreenderem bem o que seja liderança. A liderança é o esforço de exercer conscientemente uma influência especial dentro de um grupo no sentido de levá-lo a atingir metas de permanente benefício que atendam às necessidades reais do grupo.
...
Certa vez, o evangelista D. L. Moody perguntou a um pequeno grupo presente a uma reunião: "Quantos aqui creem que Deus pode encher de gente as cadeiras deste salão?" Todos levantaram as mãos.

"Quantos de vocês creem que Deus encherá de gente as cadeiras deste salão?" Menos de trinta pessoas levantaram a mão.
...
Como não conhecia sua família, decidiu chamar-se George Washington Carver porque gostava do nome. Ainda garoto, quando vagueava por certo lugar no sul dos Estados Unidos, viu uma multidão rebentar os miolos de um homem negro e queimar seu corpo em praça pública; isso lhe causou forte impressão.
...
Os quadros de flores de Carver foram premiados na Exposição Mundial da Colômbia. Seu gênio musical conquistou-lhe uma bolsa de estudos no Conservatório de Música de Boston. Mas preferiu especializar-se em química industrial numa escola superior.
...
Que bênção aquele homem foi para mim! Continuei a ampliar meu vocabulário, mas a crítica dos meus amigos moderou meu entusiasmo na exibição das novas palavras aprendidas.
...
— Quantos filhos o senhor tem? — Três.
...
O estabelecimento de metas é uma disciplina contínua do verdadeiro líder. Se ele falhar nesse ponto, destruirá a confiança dos seguidores porque destruirá sua credibilidade.
...
O líder que se espelha em Cristo ama a Deus, a si mesmo e ao seu próximo. É emocionalmente são porque é espiritualmente sadio.
...
Ó Divino Mestre, que eu não procure tanto Ser consolado, como consolar; Ser compreendido, como compreender; Ser amado, como amar; Pois é dando que recebemos; É perdoando que somos perdoados; E é morrendo que nascemos para a vida eterna.
...
O amor é o pai da bondade, portanto ela só funciona na área da beneficência e do auxílio. A bondade encontra sua âncora no amor, não no legalismo nem no "capachismo". Nem o legalista, nem o bajulador oferecem beneficência ou socorro.
...
A liderança exercida em amor funciona! É o líder se dando aos outros para levar-lhes beneficência e ajuda. A liderança firmada sobre essa base nunca irá fracassar.$conteudo$
...
Temos que concordar em que isso é ridículo!
...
O princípio do investimento acha-se resumido nas palavras de Cristo: "Dai, e dar-se-vos-á; boa medida, recalcada, sacudida, transbordante, generosamente vos darão; porque com a medida com que tiverdes medido vos medirão também" (Lc 6.38).$conteudo$
...
Oitavo, comecemos a executar o novo programa imediatamente. Se o erro está causando dificuldades ao programa, a procrastinação só vai piorar a situação.
...
Pouco antes de Bob Pierce falecer, ele me disse o seguinte:
...
A dedicação à tarefa e a persistência nela nos levam a superar a oposição e a perseguição. O apóstolo Paulo fala da oposição que recebeu: "...em trabalhos, muito mais; muito mais em prisões; em açoites, sem medida; em perigos de morte, muitas vezes. Cinco vezes recebi dos judeus uma quarentena de açoites menos um; fui três vezes fustigado com varas, uma vez apedrejado, em naufrágio três vezes, uma noite e um dia passei na voragem do mar; em jornadas muitas vezes, em perigos de rios, em perigos de salteadores, em perigos entre patrícios, em perigos entre gentios, em perigos na cidade, em perigos no deserto, em perigos no mar, em perigos entre falsos irmãos; em trabalhos e fadigas, em vigílias muitas vezes; em fome e sede, em jejuns muitas vezes; em frio e nudez. Além das coisas exteriores, há o que pesa sobre mim diariamente, a preocupação com todas as igrejas." (2 Co 11.23-28.)
...
Uma senhora da congregação disse que não tinha dinheiro, mas daria sua aliança. Outra disse que, sem contar as roupas que estava vestindo, seu único bem material era um acolchoado que ela daria para os fundos de construção da igreja. Dormiria quando uma outra mulher, com quem ela morava, estivesse acordada, e usaria o acolchoado dela.
...
O poder de persistência garante o sucesso. O líder enfrentará problemas e desencorajamentos, mas poderá vencê-los com o poder de persistência.$conteudo$
...
7. O princípio do investimento. É possível alguém beneficiar-se do princípio do investimento sem ter essa conscientização, mas isso seria o resultado de uma ação casual. O líder eficiente há de querer planejar seu uso do investimento para maximizar os benefícios dele para seu grupo. 8. O princípio da oportunidade. Nossas maiores oportunidades nos aparecem habilmente disfarçadas em problemas insuperáveis. Estando plenamente consciente da situação, o líder pode condicionar-se a ver oportunidades em toda parte.
