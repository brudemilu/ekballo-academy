-- Seja um Líder de Verdade (John Haggai) — reextração do PDF-fonte.
--
...
A chamada de líderes é necessária porque estamos experimentando uma crise de liderança em nosso mundo. E semelhante à crise de liderança espiritual que a Europa do século XVIII experimentou. Os agnósticos mostravam-se agressivos. Os livros de Morgan e Hume, com sua negação de tudo que era certo e nobre espiritualmente, eram publicados e distribuídos com afoita desenvoltura. O populacho em geral considerava o cristianismo como um castelo no ar e seus ensinos eram bons apenas para o ridículo. Voltaire, que criticou o sobrena-turalismo, a religião e o cristianismo, era o mais popular escritor da Europa. Frederico o Grande, da Prússia, era ateu praticante. Por toda a Europa, os homens estavam saudando o desaparecimento do cristianismo.
...
Atualmente, há alguns exemplos de liderança forte, mas são raros. A 26 de junho de 1983, por exemplo, li um editorial de William Pfaff, no International Herald Tribu-ne, em que ele tece elogios ao Papa João Paulo II:
...
“O papa, obviamente, não espera retirada de A liderança é o esforço de exercer conscientemente uma influência especial dentro de um grupo no sentido de levá-lo a atingir metas de permanente benefício que atendam as necessidades reais do grupo.

exércitos, colapso de alianças, levantamento da Cortina de Ferro. Não obstante, pensa em modificar os termos em que os poloneses e outros povos da Europa Oriental são governados, bem como forçar as autoridades comunistas a fazerem algumas concessões.
...
GaaÂcieníemfíiite indica uma dedicacão total da parte do líder à sua tarefa de liderar. Para todos os líderes, e principalmente para o líder evangélico, tal compromisso deveria ser de natureza espiritual. Acredito firmemente que o compromisso espiritual, em lugar de enfraquecer as empresas ditas seculares, as fortalece. A liderança espiritual leva o selo de uma inigualável superioridade, em qualquer_oarte do mundo. Em momentos de reveses dolorosos, ela fornece força e sabedoria. Nas horas de grandes vitórias, manifesta gratidãoje. humildadg.

Por todo o mundo um crescente número de líderes, de todos os ramos de atividades, sem constrangimento algum, coloca sua Bíblia sobre a mesa de trabalho; inicia as reuniões de diretoria com uma palavra de oração, e relaciona suas atividades aos princípios das Escrituras. Tenho constatado isso no Japão, nas Ilhas Fiji, na Alemanha e no Líbano, no Brasil e no Canada, no subcontinente da índia e no grande continente da África.

Um verdadeiro líder exerce uma influência especial. Essa influência não é forçada sobre os outros. Muitos que se acreditam líderes, não passam de prepotentes a pressionar outros. As pessoas os seguem por medo. A força do verdadeiro líder, entretanto, deriva da pro-funda confiança que_Sfiiis seguidores depositam nele. Estão convencidos de que, com ele e por meio dele, podem alcançar objetivos pessoais, humanitários, eno-brecedores que glorificarão a Deus, os quais, de outra maneira, parecem improváveis ou inatingíveis. Os que seguem um verdadeiro líder o fazem por amor e respeito, Rorque elarevela arnor^hurnildade, e autocontrole. Jesus Cristo, naturalmente, constitui nosso maior exemplo a esse respeito. Ele disse aos seus discípulos: “ge me amais, guardareis os meus mandamentos” (Jo 14.15).

Pessoas que são, de algum modo, homogêneas, constituem um grupo. Possuem alguma característica em comum. Talvez sejam membros de uma mesma família ou tribo, tendo os mesmos avós ou ancestrais. Talvez sejam membros da mesma igreja. Talvez sejam ex-alunos de uma escola e, portanto, todos receberam igual formação educacional. Ou, quem sabe, sejam cidadãos do mesmo país. E jrsscnçial queo. líder.-CQmpre.enda a similitude do grupo bem como todas as suas implicações.

Mais importante do que ter a mesma origem, educação ou nacionalidade, entretanto, é ter unidade de propósito. As pessoas se sentem mais como um grupo quando compartilham um mesmo objetivo. Esse objetivo pode ser o de aumentar o número de membros de uma honra a Deus e beneficia igreja, ou impedir que determinada lei seja aprovada. Um exemplo de unidade de propósito foi a mobilização empreendida pelo Presidente Roosevelt para que os Estados Unidos entrassem na Segunda Grande Guerra, justamente quando, poucos meses antes, a nação americana se mostrava isolacionista. Um exemplo de unidade de propósito para o mal foi a unificação dos nazistas efetuada por Hitler com o propósito de exterminar os judeus e estabelecer o controle do mundo.

QJa t orjnais importante para formar um grupo coes o é a unidade de propósito. A capacidade do. líder no sentido de encorajar tal unidade é um fator importante para neu sucesso à frente dele.

AqialayraffleiQS. tem dpis.significados. De um modo geral, ela se refere à visão do líder, a algo que ele quer que o grupo.seja ou faça. Esse conceito é desenvolvido no capítulo 2. E a visão que distingue uma pessoa e faz dela um líder. Suu_missãfi_._é_ empenhar-se IIQ sentido de atuarem em função da visão. Mas o termo meias aplica-se também a uma série de realizações específicas mensuráveis destinadas a levar a cabo a missão. Estudaremos a elaboração de metas no capítulo 3.
...
Os doze princípios de liderança encontrados neste livro podem ser usados para o bem ou para o mal. Idi Amin, Hitler e Nero revelaram notáveis características de liderança, mas sua influência corrompia, destruía e arruinava. Sua liderança resultou em malefício perma tatal acesso ao conhecimento de Deus, estão criando nm malefício permanente.

Este livro foi escrito para os que desejam praticar uma liderança com a dimensão do permanente benefício. O critério máximo é uma liderança semelhante à de Cristo, m^a a humamf Umllder.deve ter boa compreensão das necessidades reais dos outros. Ele mantém uma spnsihuidaHe. uma confiou e pelas qnais é responsável. Ele está sintonizado com seu ambiente, avalia meticulosamente a situação e se prepara antes de entrar em ação..,Mas siia._sensibil.ida-rie om jelnção ^nns,-outras á__sempre... focalizada pela perspectiva da visão que Deus lhe deu. Ele procura conduzir o grupo para as metas que atenderão às necessidades dessas pessoas — quer o grupo tenha ou não consciência delas. Para se exercer esse tipo de liderança mento da vontade de Deus. A História está cheia de exemplos de grupos que quiseram algo que não atendia à sua real necessidade. Samuel, por exemplo, obteve permissão de Deus para deixar os filhos de Israel escolherem um rei de modo que pudessem ser como seus vizinhos pagãos — ainda que isso não estivesse atendendo às suas reais necessidades. Por.outro lado. Abraão Lincoln con-duziu.oa Estadas Unidos a metas que atenderam, às-reais necessidades do povo — união comuherdade para todos os cidadãos — embora muitas pessoas não entendessem o permanente benefício que resultaria disso.

A-liderança, então, é_Q.esfbr.pQ.deo.xerc£r.xonsGj.ente-mente uma especial influência_dentro de.um.grupo.. a fim de levá-lma atingir metas de permanência benéfica que atendam às suas reais necessidades.
...
Em 1980, a Harvard Business fíeview compilou quinze artigos acerca de liderança sob o título Caminhos Para o Progresso Pessoal: um Líder Não Nasce Feito, Faz-se. Esses artigos explicam que como um cirurgião, um astronauta, ou um òrador sacro, um líder não nasce feito, mas se faz. Deus pode dar dons especiais a alguns, mas esses dons jamais virão à tona se eles não fizerem algum esforço para desenvolvê-los e exercitálos.
...
Se tal atitude pode superar a falta de aptidão em outras áreas da vida, pode vencer, também, a falta de aptidão para liderança. Em You Can Be a Powerful Leader (Você pode ser um grande líder), Ivan W. Fitzwa-ter diz que a liderança não é um traço inato nem uma tendência herdada. Diz ele que a verdadeira diferença entre uma pessoa que é líder e outra que não lidera é apenas uma questão de atitude.
...
Para o crente, uma posição de liderança deve levar a um forte empenho na evangelização do mundo. A evange-lização do mundo, para os cristãos, não é um passatempo, mas uma prioridade absoluta. Assim, se o crente ocupa uma posição de liderança sobre incrédulos, o primordial benefício permanente que o líder deve desejar para os seus seguidores é que sejam salvos por Jesus Cristo. Se o crente está numa posição de liderança sobre outros cristãos, ele deve levá-los a interessar-se pela evangelização do mundo. O verdadeiro cristão jamais coage.

Cristo, inequivocamente, ordenou a todo crente que dê à evangelização do mundo um lugar de prioridade em sua vida. Ele disse, por exemplo: “Ide, portanto, fazei discípulos de todas as nações, batizando-os em nome do Pai e do Filho e do Espírito Santo.” (Mt 28.19; ver também Mc 16. e At 1.8.)

Há muitos modos de pôr em prática a ordem de Cristo no sentido da evangelização do mundo. De um lado, cada ato e atitude do crente deviam concentrar-se nesse objetivo. Mas evangelização não significa, apenas, ser um missionário ou pastor. Eu me lembro de líderes falecidos tais como a Dr.a Helen Kim, uma eminente educadora da Coreia, Thomas F. Staley, diretor de um banco de investimentos de Wall Street, de Eliseo Pajaro, um destacado músico das Filipinas, de John Bolten, Sr., um industrial germanoamericano, e de Benjamim Moraes, um jurista, linguista, professor e pastor do Brasil. Posto que todos esses eram líderes em seus campos de ação, lembramos que todos estavam, também, cumprindo a ordem de Cristo para a evangelização do mundo.
...
O que é liderança? E o esforço de exercer conscientemente uma influência especial dentro de um grupo para levá-lo a atingir metas de permanente benefício que atendam às reais necessidades do grupo.
...
Quando John Sung voltou à sua terra natal, a China, em 1929, depois de haver recebido seu diploma de doutor em filosofia — seu Ph. D — da Univerdidade do Estado de Ohio, seu pai — um pregador — lhe disse: “Bem, John, agora, com a sua instrução, você pode conseguir um cargo elevado no ensino e providenciar educação para os seus seis irmãos.” Na China, os filhos sempre obedecem às ordens diretas de seus pais. Portanto foi uma atitude insólita, a de John, quando disse a seu pai que não podia assumir um posto de ensino porque Deus o tinha chamado para evangelizar a China e o sudeste da Ásia. Seu ideal era ver chineses se tornando seguidores de Jesus Cristo, e ele sentia que só dispunha de quinze anos para realizar essa visão.

Nos quinze anos seguintes John Sung trabalhou por doze homens. E, de fato, ao fim daqueles quinze anos, em 1944, ele morreu! John Sung tinha-se dedicado ao cumprimento de sua visão. Isso explica o ritmo febril que imprimiu à realização dela. A Ásia e o Pacífico Sul hoje são diferentes por causa do seu ministério. E tudo começou com uma visão que se traduziu numa missão executada através de metas bem definidas. __ O Mahatma Gandhi teve a visão de uma índia livre e independente numa época em que ela era governada pela Inglaterra. Henry Ford teve a visão de cada família dos Estados Unidos possuindo seu próprio automóvel, em dias quando a maioria das pessoas se sentia aterrorizada com a nova invenção. William Wilberforce teve a visão da abolição da escravatura numa ocasião em que os escravos constituíam artigo muito lucrativo para os ingleses. Daniel K. Ludwig teve uma visão de uma região industrial economicamente independente no coração da selva brasileira, numa época em que não havia nem indústria, nem eletricidade, nem cidade alguma num raio de centenas de quilômetros. E o Mahatma Gandhi, Henry Ford, William Wilberforce e Daniel Ludwig se devotaram à imagem clara que tinham daquilo que queriam que o grupo deles fosse ou fizesse em conseqiiência da influência especial que exerceríam.
...
Mas não basta ter uma visão. Importa haver uma dedicação no sentido de agir em função dela. A isso se chama uma missão. E preciso haver uma série de passos específicos, mensuráveis, para cumprir a missão. Esses passos são chamados metas. As metas constituem o programa a ser desenvolvido para se cumprir a missão e, assim, tornar realidade a visão. O líder só tem uma visão, bgpi como uma só missão, mas dever á_ ter muitas metas.
...
Uma missão é simplesmente uma visão levada à ação. Isto é claramente ilustrado pelo programa Apoio, dos Estados Unidos.

Em 1960, o Presidente John Kennedy lançou um desafio ao povo americano com seu sonho de mandar um americano à Lua em 1970. Isso era uma visão. Quase imediatamente o governo lançou um programa destinado a tornar realidade essa visão — a missão Apoio. O presidente comunicou sua visão ao povo americano. O povo, através do governo, comprometeu-se, então, com a realização dessa visão com uma missão. A missão reaue-rja um, pia no elaborado que consistia de milhões de metas.

À história de Neemias revela que ele tinha a visão de reconstruir as muralhas de Jerusalém. Neemias estava no cativeiro, a 1500 quilômetros da cidade. Era um servo, copeiro do Rei Artaxerxes, da Pérsia. A cidade santa de Jerusalém tinha sido conquistada e grande parte dela fora destruída. Mas Neemias tinha a visão de uma Jerusalém reconstruída, cercada de fortes muros, para a glória de Deus. Sua missão era levar essa visão à realidade. Então criou um elaborado sistema de metas para cumprir a missão. Seu primeiro passo foi orar. A seguir, Neemias apresentou seu caso ao Rei Artaxerxes. Depois, elaborou um plano para a reconstrução dos muros e para derrotar a oposição. Neemias é um dos melhores exemplos de exercício de liderança, na História.

E uma coisa grandiosa ser consumido pela visão da evangelização do mundo — ter a imagem de cada pessoa de nosso planeta ouvindo o evangelho de maneira compreensível e culturalmente relevante. Mas criar uma missão destinada a tornar realidade essa visão é algo maior. E criar, sob a direção de Deus, os programas de metas necessárias para levar a cabo a missão e realizar a visão, é ainda maior.
...
Pensar continuamente na visão induz à ação. E dar o toque de finados para a complacência. Como disse o sal-mista: “Esbraseou-se-me no peito o coração; enquanto eu meditava ateou-se o fogo” (SI 39.3).
...
Hoje, o Instituto de Motivação de Sucesso — Success Motivation Institute — de Paul Meyer tem ajudado milhares de pessoas. Líderes de setenta e cinco países apontam o programa do SMI como o instrumento que lhes abriu um novo mundo de possibilidades. O programa do SMI transformou algumas pessoas que antes recebiam auxíliodesemprego em executivos e bolsistas universitários.

E trágico que tantos filhos de Deus pareçam indiferentes às oportunidades que os cercam. Contentam-se com o mínimo, quando Deus os quer dirigindo os mais altos escalões do progresso.
...
Depois de obter um melhor conhecimento de Deus, o líder cristão deve conhecer a si mesmo. Uma auto-ava-liação precede qualquer realização de permanente benefício. Aquele que quer ser um líder que Deus pode usar, vê seu potencial como Deus o vê.

Quando o líder obtém uma clara visão de si mesmo, pode ser tentado, como Isaías, a lamentar-se: “Ai de mim! Estou perdido! porque sou homem de lábios impuros, habito no meio dum povo de impuros lábios.” Ele pode pensar, como Moisés, que a inaptidão o desqualifica para a tarefa. Mas Deus opera através do pecador, através de pessoas inadequadas, se elas tiverem fé, não em sua própria capacidade, mas no poder de Deus — que aliás foi quem lhes deu a visão. E necessário ter fé para acolher a visão, convertê-la numa missão, implomonlá-la através de um programa de metas apropriadas, o mobilizar outros de modo a atenderem às suas reais necessidades. O líder que tem o espírito de Cristo não somente devo ter um entendimento de Deus e de si mesmo, mas devo ter, também, um bom conhecimento das necessidades reais dos outros. Sua sensibilidade para com outros é sempre focalizada através da visão que Deus lhe deu. - A falta de visão, de percepção e de sensibilidade quanto às necessidades de outros, produz em nós._a^-corrasão_do espírito e confusão da mente.

COMPREENDA POR QUE UMA VISÃO É IMPORTANTE

Sem nma entusiástica.dedicação a uma visao^. ninguém pode ser um bom líder. Alguém pode até estar numa posição de liderança, pode ser um administrador, mas o que distingue o verdadeiro líder dos outros é o fato de ele possuir uma visão. Isso é importante porque constitui a chave mestra para uma liderança vitoriosa.

E a visão que dá base e sustentação a todo ato de liderança. Sem visão não pode haver uma missão adequada. Sem missão, não há possibilidade de um produtivo programa de metas. Sem o programa de metas não há liderança. Sem liderança, o mundo enfraquece em pecado e tristeza. A liderança começa com uma visão.
...
2. Diga-me, em um mínimo de cinqiienta páginas, qual é o seu potencial pleno em cada área de sua vida. (Daniels exige, no mínimo, cinqiienta páginas. De outro modo, o interessado poderia escrever poucas palavras que, como diz Daniels, seriam “insignificantes”. Obrigando as pessoas a escrever pelo menos cinqiienta páginas, força-as a confirmarem sua sinceridade de propósito.

3. Definindo o seu potencial máximo como sendo 100 por cento, qual a porcentagem média do conceito que você se atribuiría no momento?
...
Dwight L. Moody teve a visão de estabelecer um instituto bíblico que prepararia leigos para se tornarem eficientes na evangelização. Era um conceito novo. Deus deu essa visão a Moody, um comerciante transformado em evangelista. Ele, por sua vez, teve de acender a chama de modo que outros pudessem ver 11 visão o dedicar-se à missão.

No final da Segunda Grande Guerra Deus deu ao Dr. Han Kyung Chik a visão de uma igreja em Seul, Coreia. Inicialmente só vinte e sete pessoas — todos refugiados — participaram de sua visão. Hoje, a igreja conta com 60. membros, construída não por uma só pessoa, mas por muitos seguidores que assimilaram sua visão.
...
Agora já sabemos o que é uma visão, de onde ela provém, por que é importante que o líder tenha uma visão e quem deve apropriar-se dela. O que vamos fazer com a visão? A resposta é óbvia: passamos a atuar em função dela (essa atuação é chamada do missão) e, em seguida vamos delinear um programa de metas para realizar essa missão, a assim atender à^visão. Nessa atuação deve estar, a determinação de vencer dificuldades e de eliminar obstáculos.
...
A importância desse comprometimento pode ser vista mais dramaticamente quando a visão parece menos lógica. Em 1929, WillH. Houghton, pastor do Tabernácu-lo Batista, de 4. membros, de Atlanta, Geórgia, estava viajando pela Europa em companhia da esposa e da mãe desta. À meio caminho do roteiro planejado, Houghton sentiu uma espécie de premência para voltar imediatamente para os Estados Unidos. Ele não sabia por que, mas sabia que Deus estava mandando que voltasse.

Deixou que a esposa e a sogra prosseguissem na viagem completando o roteiro planejado, enquanto embarcava no navio mais rápido com destino a Nova Iorque. Chegou numa quarta-feira a tempo de participar do culto de oração na Igreja Batista do Calvário, que fica em frente ao famoso Carnegie Hall.

O pastor, John Roach Straton, havia adoecido gravemente, e Houghton foi solicitado a assumir temporariamente o púlpito. Em janeiro de 1930 ele voltou à Igreja Batista do Calvário, pregando na cidade que muitas vezes tem sido chamada de “túmulo dos pregadores”. Straton faleceu em outubro de 1930, e Houghton aceitou o convite para ficar com o pastorado. Ele foi um dos poucos que conseguiram ter sucesso como pregador na cidade de Nova Iorque.
...
Deus deu a John Sung a visão de evangelizar o leslo da Ásia, e ele modificou a fisionomia espiritual de cada nação que visitou.

Se Deus pôs um desejo em seu coração, aceite a presença desse desejo como uma afirmação divina de que ele pode ser realizado, e dedique-se ao cumprimento da visão.
...
Muitas vezes um líder se vê forçado a tomar uma decisão rápida sem o benefício de reflexão e deliberação anteriores. E nessa situação que o poder do isolamento voluntário o ajuda a pensar, estabelecer seu curso de ação e determinar os planos a serem executados... para benefício do grupo.
...
— Suponha que, hoje à tarde, às três horas, o senhor tivesse de tomar uma decisão inadiável que iria afetar milhares de vidas inocentes e envolvería milhões de dólares pertencentes a outras pessoas, e só tivesse dois minutos para decidir: o que faria?

— Seguiría meu bom-senso.

Estupefata, ela disse:

— Quer dizer qua não oraria a respeito?
...
E numa situação como a que foi apresentada por aquela senhora, que precisamos saber encontrar o isolamento em meio à agitação.

Mas quer o líder receba a visão num belo local amplo e solitário ou num isolamento mental por ele mesmo criado, deve didicar-se ao cumprimento da visão, senão sua influência dará em nada.

O líder que se espelha em Cristo precisa estar sempre se perguntando: (1) essa visão produzirá resultados de permanente benefício? e (2J levará as pessoas a metas que atenderão às suas reais necessidades?

Para esse líder a visão é a revelação da vontade de Deus. O líder aceita o desafio da visão, dedica-se à missão, e procura atingir as metas que possibilitarão a realização da missão e cumprimento da visão.

Mas tudo isso começa com a visão — o fundamento da liderança.

SUMÁRIO

A liderança começa com uma visão. Uma visão é uma imagem clara do que o líder vê seu grupo ser ou fazer. Uma visão pode ser de saúde onde há doença, de conhecimento onde há ignorância, de liberdade onde há opressão, ou de amor onde há ódio. O líder se sente inteiramente dedicado à sua visão, o que implicará em mudanças benéficas para seu grupo.
...
A visão é a revelação da vontade de Deus; é o fundamento da liderança.$conteudo$,
      audio_leitura_url = null
  where curso_id = v_curso_id and ordem = 2;
  -- 3. O Princípio do Estabelecimento de Metas
  update public.aulas
  set conteudo =
...
O falecido Cecil B. Day, Sr., teve a visão de incrementar um negócio visando à geração de fundos para a obra de Deus em todo o mundo. A parte mais visível do seu negócio era a cadeia de hotéis que fundara — o Day’s Inn. Em quatro anos ele montou diversos hotéis, num total de 40. quartos. Ninguém jamais realizou tal façanha, nem antes, nem depois dele.
...
O líder precisa ter a visão, mas ela se cumprirá por meio do atingimento de metas. Ele não pode perder tempo com interesses supérfluos. Não há dúvida de que Napo-leão teve uma visão. Ele se viu como imperador de toda a Europa. E sabia entusiasmar os que lutavam com ele. Mas falhou porque seu plano egomaníaco não podia, jamais, cumprir a visão de conquistar todo o continente.

A visão é o fundamento de toda liderança. A visão do líder exige total dedicação à ação. Essa dedicação é chamada de missão. Mas o ponto realmente crítico é o estabelecimento de uma série de passos específicos e mensuráveis, coto o objetivo de realizar a missão. Esses passos se chamam metas. Um líder sem metas é como o capitão de um navio sem pontos de referência ou um piloto de corrida cross-country sem placas de sinalização e identificação dos locais.

No início dos anos setenta, o sociólogo Daniel Yanke-lovich disse que os jovens estavam desiludidos. Afirmou que um elevado número dentre os mais instruídos e mais promissores adultos jovens tinham perdido o entusiasmo por sua carreira profissional. Havia uma “crise de objetivos”.
...
Se alguém disser: “Meu objetivo é glorificar a Deus”, isso não é uma meta satisfatória. Trata-se de um anseio válido, claro, mas não descreve um passo que o levará ao cumprimento de sua visão. Seria o mesmo que ouvirmos Noé dizendo: “Quero sobreviver ao dilúvio”, ou Neemias dizendo: “Quero proteger Jerusalém”.

Cada meta deve ser um passo específico, e não um desejo vago.
...
Eu tinha uma meta intermediária de estar com o manuscrito pronto em maio de 1985. Então, estabeleci metas pessoais para a feitura de cada capítulo: teria que fazer um por mês durante doze meses, e ter um mês no fim para revisão e nova redação. Cada uma dessas metas menores era específica, mensurável, atingível, realística e tangível.

Algumas dessas metas menores tinham prazo de apenas um mês. Eu havia dividido minha meta maior — escrever este livro — em submetas. Se minha meta imediata fosse escrever o livro, teria de enfrentar uma tarefa esmagadora. Minha tendência teria sido não fazê-lo. Mas, dividindo-a em capítulos de um mês cada um, sabia dizer prontamente se estava ou não realizando a tarefa.
...
“Embora se possa dizer muita coisa em favor da coragem, do entusiasmo e do “esforço da velha escola”, estes atributos podem causar mais mal do que bem se eles permitirem que a emoção anule o bom-sen-so ou estimule a dedicação de tempo, esforço e dinheiro a objetivos que são inatingíveis.”
...
Moisés mandou doze espias a Cades-Barneia para espiar a terra prometida. Eles a descreveram como uma terra que mana leite e mel, abundante em frutos incomparáveis.

Todos concordaram em que era uma terra desejável, mas dez deles aviltaram o relato e aterrorizaram os israelitas com sua descrição dos “gigantes” da terra. “Não poderemos subir contra aquele povo”, disseram.
...
“Terei minha hora silenciosa nos primeiros trinta minutos de cada dia, quando lerei a Bíblia e orarei.” “Não apenas dedicarei os primeiros momentos do dia a assuntos espirituais, mas, também, consagrarei o primeiro dia da semana e a décima parte do que ganho ao Senhor e à sua obra.”

“Pelo menos em cinco dias da semana, irei testemunhar a outros o que o Senhor tem feito por mim.” “Pelo menos uma vez por semana, deixarei minha comodidade, se preciso for, para visitar alguém que esteja com algum problema, com o propósito de animá-lo e ajudá-lo em nome de Jesus.”

Fazer metas tangíveis é o único modo realista de executar metas intangíveis.

Além de fazer metas específicas, mensuráveis, atin-gíveis, realistas e tangíveis, existem outros princípios que são úteis.
...
O ideal seria que nossas metas fossem sempre baseadas em fatores que estão sob nosso controle — que nós ou aqueles que trabalham conosco podem fazer. Mas esta é uma área que se constitui num problema para as organizações cristãs e para as que não têm fins lucrativos, e que dependem do trabalho de voluntários. Nem sempre se consegue de obreiros voluntários a mesma cooperação que conseguimos dos que são empregados. E por isso que, em muitos negócios, um administrador pode controlar diretamente o trabalho dos seus subordinados, mas, em muitas organizações cristãs, a excelência da liderança se revela na motivação que as pessoas têm no servir ali.

Deixemos nossa mente elevar-se. Não limitemos a Deus, nem as cõisas maravilhosas que ele tem guardadas para nós, permitindo que experiências prévias ou a observação do desempenho de outros embacem nossa visão.

Certa vez, o evangelista D. L. Moody perguntou a um pequeno grupo presente a uma reunião: “Quantos aqui crêem que Deus pode encher de gente as cadeiras deste salão?” Todos levantaram as mãos.

“Quantos de vocês crêem que Deus encherá de gente as cadeiras deste salão?” Menos de trinta pessoas levantaram a mão.

“Estão vendo”, disse ele censurando, “não há necessidade de fé para dizer que Deus pode fazer isso; mas é necessária uma grande fé para dizer que Deus fará isso.”
...
Certifiguemo-nos de que as metas implicam em mudanças de comportamento. Podemos estabelecer metas para cultivar características que não possuímos. O esforço visando a mudanças pessoais é um fator essencial no estabelecimento de metas. Nossos padrões de conduta devem ser compatíveis com nossas metas.
...
Metas próprias. É preciso ter personalidade forte para estabelecer metas próprias, principalmente quando elas são diferentes da norma em nossa sociedade. Continua sendo impossível para Davi lutar com a armadura de Saul. E ê igualmente impossível que alguém lidere com metas estabelecidas por outrem.

Esse princípio se aplica também a todos os níveis de uma organização. Cada indivíduo da organização deve estabelecer suas próprias metas. E claro que o diretor geral pode dar uma orientação básica para o estabelecimento delas, e que as metas de cada um deve convergir para as metas e objetivos globais da organização; mas, se cada funcionário estabelecer suas próprias metas, terá maior probabilidade de realizá-las e menor probabi-dade de culpar outros se elas não forem alcançadas.

Um jovem negro chamado Carver discerniu sua visão bem cedo na vida, e orientou-se por ela para estabelecer suas metas, sem se importar com o que os outros pensavam.

Como não conhecia sua família, decidiu chamar-se Ceorge Washington Carver porque gostava do nome. Ainda garoto, quando vagueava por certo lugar no sul dos Estados Unidos viu uma multidão rebentar os miolos de um homem negro e queimar seu corpo em praça pública; isso lhe causou forte impressão.
...
Os quadros de flores de Carver foram premiados na Exposição-Mundial da Colômbia. Seu gênio musical con-quistou-lhe uma bolsa de estudos no Conservatório de Música de Boston. Mas preferiu especializar-se em química industrial'numa escola superior.
...
Antes de cada um desses períodos de trabalho, que podiam durar de quinze minutos a uma hora e meia, eu fazia minha hora silenciosa e, veementemente, pedia a Deus para orientar-me. Sentia-me grandemente edifica-do com as palavras de Tiago: “Se, porém, algum de vós necessita de sabedoria, peça-a a Deus, que a todos dá liberalmente, e nada lhes impropera; e ser-lhe-á concedida” (Tg 1.5). E ficava sempre dizendo ao Senhor que me habilitava àquela sabedoria, porque tinha falta dela.
...
Além de anotar essas coisas, fiz também uma lista de meus defeitos e qualidades. Escrevi todos os meus atos e atitudes que lembrava e que poderíam representar um defeito. Escrevi, também, todas as críticas que me lembrava de haver recebido. No outro lado da folha, anotei Iodas as qualidades que julgava possuir. Além disso, pus lambém todos os elogios que tinha recebido. Isso me ajudou a ver-me a mim mesmo de uma forma que nunca vira antes e me ajudou a definir com clareza a missão que Deus me confiara.

Sinto o rosto queimar, quando confesso que foi somente com trinta e tantos anos que, afinal, consegui concluir uma definição objetiva da minha missão na vida o das metas que teria de estabelecer para atingi-la. E verdade que recebera o chamado para ser pregador quando tinha seis anos de idade. E desde os dez anos, já sabia que queria me dedicar ao evangelismo mundial. Nesse sentido, minha visão permaneceu a mesma, sem mudança. Mas só quando estava chegando aos trinta e cinco foi que elaborei meu plano de vida sob a direção divina.

Depois especifiquei as realizações que sentia serem necessárias — tanto minhas realizações pessoais quanto as dos que estariam trabalhando comigo — para que minha missão fosse executada. Isso envolvia todas as áreas da vida e atividade, incluindo o local onde residiría, meu estilo de vida pessoal, condições de viagem, desenvolvimento mental, atividades sociais, metas financeiras, metas de família, metas organizacionais e, naturalmente, metas espirituais. Achei que alguns itens eram reciprocamente exclusivos. Foi aí que tive de determinar meu sistema de valores e tomar uma decisão a respeito de prioridades.
...
Algumas das sumidades médicas do mundo dão ênfase, atualmente, à importância de metas como um impeditivo à doença e como um estabilizador da saúde. Num livro recém publicado Getting Well Again (Sarar), seus autores, o Dr. O. Carl Simonton e sua esposa, Dr.a Stephanie Mathews Simonton e James Creighton, demonstram que, o esforço para viver e o estabelecimento de metas constituem uma das mais importantes e bem-sucedidas terapias no combate ao câncer. Dizem eles que o instrumento mais eficiente para a melhora dos pacientes é pedir-lhes que estabeleçam novas metas de vida. E quando o fazem, eles visualizam e definem novas razões para viverem. É uma maneira por meio da qual esses enfermos se reintegram na vida.
...
As metas produzem persistência. O falecido Bob Pierce, fundador da “Visão Mundial”, contou-me uma história que mudou o curso da minha vida e do meu trabalho. Quando Pierce era moço, um respeitado ministro evangélico lhe disse: “Estudei líderes e organizações. Devorei biografias e autobiografias. Mergulhei na história. Observei cuidadosamente a liderança contemporânea do meu tempo. Cheguei à conclusão de quo há apenas um fator que distingue uma organização vitoriosa. É o poder da perseverança.

“Há muitos casos”, disse Pierce, citando aquele pastor, “de organizações chefiadas por líderes bem qualificados por sucessos na área educacional, pessoas de grande projeção, dons naturais e amigos influentes que fracassaram e fecharam, enquanto as de líderes com vantagens aparentemente menores alcançaram realizações espetaculares. O que houve é que os últimos simplesmente exercitaram o poder de perseverança. Os vencedores são aqueles que, quando estavam como que pendurados numa saliência da rocha prestes a se esbor-rachar no abismo, os dedos sangrando como se suas unhas estivessem sendo arrancadas, continuaram se agarrando. De certa forma, de algum modo, Deus interveio; honrou sua perseverança e os livrou.” Suas metas produziram persistência.

A baixo de Deus, são as metas que impedem que o líder fique escravizado aos aplausos dos outros. E possível que não haja nenhum outro perigo que mais ameace a eficiência da liderança do que estar escravizado aos aplausos da multidão. Tal escravidão toca as raias da idolatria. Pouco antes de sua morte, o Dr. J. C. Massee, cujos sermões dominicais foram publicados semanalmente nos jornais de Boston durante o seu ministério de sete anos, de 1922 a 1929, disse: “A doença mais virulenta que está ameaçando o evangelismo americano é a louca paixão pelo aplauso”. E citou, então, João 5.44: “Como podeis crer, vós os que aceitais glória uns dos outros, e contudo não procurais a glória que vem do Deus único?”

Pouco antes de aposentar-se, nos princípios de 1960, o redator do Boston Herald me disse: “Massee foi o mais citado pregador de Boston durante meus quarenta anos no jornalismo, mas ele parecia inacessível à aclamação”. Massee pregava a um auditório de 2. pessoas, tanto de manhã como de noite, durante todo o seu ministério em Boston. Um propósito mais elevado que ter fama, executado por meio de metas claramente definidas, o manteve livre da escravidão à instável reação das multidões.

O MEDO DE ESTABELECER METAS

Se estabelecer metas é tão maravilhoso, por que são poucas as pessoas que o fazem? Devo admitir que a razão primária ê provavelmente porque o estabelecimento de metas exige muito esforço. Requer determinação. Requer dedicação à tarefa. Mas há, pelo menos, quatro razões que levam as pessoas a ter medo de estabelecer metas.
...
Justamente quando me dispunha a abandonar o esforço para ampliar meu vocabulário, um pregador rural me disse: “John, você está caprichando no seu vocabulário.” Eu estremecí. Ele notou e continuou: “Não se sinta constrangido. Eu admiro você. A princípio, é possível, que pareça um pouco afetado, mas quero encorajá-lo não só a continuar, mas também a manter esse treinamento pelo resto da vida. Isso aumentará sua capacidade para obter conhecimento e compreensão.”

Que bênção aquele homem foi para mim! Continuei a ampliar meu vocabulário, mas a crítica dos meus amigos moderaram meu entusiasmo na exibição das novas palavras aprendidas.

Antes do incentivo do pastor, havia abandonado a ideia de prosseguir nos cursos de leitura dinâmica e memorização. Mas, depois de vencer o temor do ridículo, prossegui com ambos.

No momento em que estabelecemos uma meta, podemos prever oposição e, possivelmente, alguma gozação. Por alguma razão, os que sabem que deveríam estar fazendo a mesma coisa sentem autocondenação por estarem-se esquivando ao desenvolvimento pessoal. Eles têm duas alternativas: ou fazem o que eles sabem que deveríam fazer, ou caçoam de nós. Por isso, considere esse tipo de gozação como um cumprimento disfarçado.

4. O medo de considerar presunção o estabelecimento de metas. Alguns podem não estabelecer metas por causa do versículo que diz: “Também da soberba guarda o teu servo” (SI 19.13). Mas o estabelecimento de metas se harmoniza perfeitamente com a soberania de Deus.
...
— Posso, também, supor que o senhor e sua esposa estão orando fervorosamente, instruindo os filhos, e criando, em seu lar uma atmosfera bem favorável que os levè a tal compromisso espiritual, enquanto, ao mesmo tempo, vão tendo o cuidado de não pressioná-los? Em outras palavras, o senhor quer que as decisões sejam deles mesmos. Estou certo no que afirmo?
...
A Bíblia Viva parafraseia Provérbios 24:3, assim: “Qualquer empreendimento é feito com planos sábios, torna-se forte com bom senso e dá resultados maravilhosos por estar em dia com os fatos.”

UMA DISCIPLINA CONTÍNUA

O estabelecimento de metas é uma disciplina contínuo do verdadeiro líder. Se ele falhar nesse ponto destruirá a confiança dos seguidores porque destruirá sua credibilidade.

Se não tivermos um programa de metas, certos fatores e outras pessoas tomarão o controle de nossa vida, quer o queiramos ou não. Se não assumirmos o controle, alguém o fará — ou alguma outra coisa. Tendo metas específicas com padrões mensuráveis nos manteremos na mira para a consecução da nossa missão.

Permita-me dar uma ilustração. Centenas de líderes de todas as partes do mundo participam do programa do Instituto Haggai anualmente. Antes de serem aceitos, eles assumem o compromisso de dirigir cursos para seus compatrícios na volta à sua terra. Concordam em instruir pelo menos 100 pessoas. Pois bem, isso pode ser uma meta dentro da estrutura da sua missão.
...
Cada um desses passos deve ser acompanhado de prazos previstos.

Ocasionalmente, alguns tiveram de alterar os planos iniciais por causa de uma estação chuvosa extemporânea ou interrupções inesperadas em sua vida cívica ou em seus programas eclesiásticos. Para manter suas atividades atualizadas, em tais casos, eles não hesitaram em mudar as metas intermediárias, mas se recusaram a mudar sua meta principal.
...
Q-estabelecimento de metas é uma disciplina contí-nua. Não se pode elaborá-las de uma vez por todas, e pronto. A constante aceleração das mudanças em pessoas, lugares e coisas que se verifica hoje exigem que tenhamos um programa de metas claramente definido.$conteudo$,
      audio_leitura_url = null
  where curso_id = v_curso_id and ordem = 3;
  -- 4. O Princípio do Amor
  update public.aulas
  set conteudo =
$conteudo$J. R. Ewing, o astro de “Dallas”, a mais popular série de televisão nos U. S. A., não chegou a ser um líder porque não conduz as pessoas para uma meta de permanente benefício. Ele destrói pessoas. Talvez tenha visão. Pode ter uma missão. Pode, até mesmo, ter um programa de metas, mas falta-lhe um ingrediente básico para a liderança — amor.
...
A grandeza intelectual de Napoleão Bonaparte e seu intenso egoísmo tornam particularmente notável seu tributo à supremacia da liderança fundada no amor. Disse ele: “Alexandre, César, Carlos Magno e eu fundamos grandes impérios; mas, sobre que fundamento criaram os nossos gênios? Sobre a força. Somente Jesus fundou seu império sobre o amor, e até o dia de hoje milhões morreríam por ele”.

Em seu livro Managing (Gerenciando), Harold Geneen faz importante distinção entre o líder e o comandante. QJíder guia seu povo; o comandante diz ao seu povo: “Eu quero isto feito nesta data, e, se não for feito, algumas cabeças rolarão!”12O comandante governa pelo medo; o líder guia por amor.

A visão distingue um líder de um gerente. E o a-mor distingue o verdadeiro líder do ditador. W. C. H. Prentice disse que, muitas vezes, confundimos liderança com popularidade, poder, domínio cênico ou capacidade para fazer um planejamento a longo prazo. A maior parte dos chamados líderes hoje — tanto dentro como fora da igreja — não são verdadeiros líderes, mas detentores do poder. E se alguém mantém sua posição por meio da popularidade ou da força não somente anula o amor, mas também vê a demonstração de amor como fraqueza clara porque ninguém pode amar sem tornar-se vulnerável. Ninguém pode amar enquanto mantiver reservas acerca de outrem. Para amar verdadeiramente — seja o cônjuge, os filhos ou as pessoas que lidera — a pessoa deve dar-se sem reservas de tal maneira que pode ser ferido, pode ser rejeitado. Mas o princípio fundamental pelo qual o detentor do poder atua é o de proteger-se a si próprio — nunca ser vulnerável.
...
O amor a que me refiro não é uma emoção sentimental. E a transferência da totalidade do ser de alguém a outrem na forma de beneficência e auxílio. O amor na forma aqui usada se refere a uma disposição da mente, um ato da vontade. Não é o exercício de emoções.
...
O amor ágape é divino. A palavra ágape é um termo essencialmente cristão, aureolado com uma glória que Deus lhe deu. Ele usou para expressar sua própria atitude para com todos os homens e mulheres.
...
O verdadeiro amor envolve a totalidade da existência de uma pessoa. Deus, e somente ele, expressa-o perfeita-mente. Ele se deu totalmente. O Homem que estava na cruz do meio era Deus. Em sua vida terrena, Jesus expressou isso quando disse: “Pois, no meio de vós, eu sou como quem serve”. Em relação à morte, ele o expressou quando disse: “Ninguém a tira (minha vida); pelo contrário, eu espontaneamente a dou.”

O amor a que me refiro é feito de atenção, filantropia e benevolência inabaláveis. Isso significa que, não importa o que alguém possa fazer para humilhar, maltratar ou ofender o líder, se ele é verdadeiramente cristão, agi rá sempre buscando o melhor para aquela pessoa. Na verdade, sem essa espécie de amor, a liderança falha na prova suprema — a permanência.
...
O líder que se espelha em Cristo ama a Deus, a si mesmo e ao seu próximo. E emocionalmente são porque é espiritualmente sadio.

Mantém uma atitude vitoriosa porque obedece fielmente aos dois mandamentos de Cristo, que constituem o ponto de partida para uma boa liderança. Um intérprete da lei reinquiriu Jesus: “Mestre, qual é o grande mandamento da lei?” E Jesus respondeu-lhe: “Amarás o Senhor teu Deus de todo o teu coração, de toda a tua alma, e de todo o teu entendimento. Este é o grande e primeiro mandamento. O segundo, semelhante a este, é: Amarás o teu próximo como a ti mesmo” (Mt 22.36-39).

Nesses dois mandamentos do Senhor, vemos as três áreas do amor: primeira, o amor a Deus; segunda, o amor ao próximo; e terceira, o amor a si mesmo. O amor que Deus demonstrou para conosco proporciona-nos o exemplo máximo de como deve ser o nosso amor. Esse amor é a comunicação do seu ser a nós na forma de beneficência e auxílio. A palavra beneficência significa a prática do bem: bondade, generosidade ou caridade — literalmente, fazer o bem. Amar a Deus, como Cristo ordena aqui, significa retribuir a Deus aquilo que ele nos deu. Isso é demonstrado por nosso amor ao próximo — que deve ser calcado no amor de Deus por nós. É disso que Jesus está falando quando menciona os atos de dar um copo de água fria ou visitar alguém na prisão “em meu nome”. E nosso amor a^ nós mesmos origina-se do fato de que Deus nos ama. E compreendendo e crendo que Deus nos ama, nos perdoa e nos aceita assim como somos, que nós podemos ter um amor-próprio sadio.

AMAR A DEUS

Cristo diz que devemos amar nosso Deus. Todo líder deve viver de tal maneira que jamais deixe dúvida na mente de qualquer um sobre quem é seu Deus. Deus diz: “Não terás outros deuses diante de mim” (Ex 20.3). Qualquer pessoa ou coisa que exerça sobre nós uma influência de formação maior do que a de Deus, é um ídolo. Um ídolo pode ser tanto um hábito, uma pessoa, uma coisa, quanto uma imagem de escultura. Uma liderança sem amor é idólatra porque substitui Deus por um ídolo. O líder que segue a Cristo despreza a idolatria.
...
Muitas vezes queremos amar o próximo, mas não sabemos manifestá-lo. Em seu livro Amigos de Verdade, 1 Ted Engstrom, presidente da Visão Mundial Internacional, oferece dez princípios muito práticos e poderosos para se exprimir amor. Esses dez princípios revelam como se expressa amor ao próximo.
...
2. “E preciso um esforço consciente no sentido de nutrir um interesse autêntico pelos outros.” A nossa tendência natural é nos concentrarmos em nós mesmos (o que não é o mesmo que ter um amor-próprio sadio). É preciso, portanto, um esforço consciente para amar.
...
7. “Diga sempre palavras de elogio e de incentivo.”

Tais palavras edificam o amor-próprio dos outros. As críticas e o desencorajamento, entretanto, matam o entusiasmo e o amor dos outros.
...
10. “Enfatize os pontos forte e as virtudes dos outros, e não seus pecados e fraquezas.” Para ilustrar esse ponto, Ted Engstrom conta a história seguinte:
...
No restante deste capítulo, apreciaremos as seis primeiras expressões do amor. Os dois últimos — humildade e domínio próprio — serão considerados nos dois capítulos seguintes, visto que ambos são, também, dois importantes princípios de liderança. Essas oito qualidades se manifestarão no líder que pratica o amor. Eis aqui o que os seus seguidores verão.
...
Onde há ódio que eu possa semear amor; Onde há ofensa, perdão; Onde há dúvida, fé; Onde há desespero, esperança; Onde há trevas, luz; Onde há tristeza, alegria.

Oh Divino Mestre, que eu não procure tanto Ser consolado, como consolar; Ser compreendido, como compreender; Ser amado, como amar; Pois é dando, que recebemos; É perdoando, que somos perdoados; E é morrendo que nascemos para a vida eterna.”
...
— Lembro-me de certa vez quando um membro do Conselho atacou violentamente a opinião do Dr. Han. O Dr. Han chorou. Ele disse: “Evidentemente não orei suficientemente antes de apresentar este assunto. Per-doem-me. Vou orar mais fervorosamente a respeito disto.” Antes de transcorrer um ano, o Conselho, unanimemente, entendeu que a proposta do Dr. Han era correta e a adotou, embora ele nunca tivesse voltado ao assunto.

O que torna essa lição tão poderosa para mim é que o Dr. Han passa muitas horas por dia em oração. Há mais de meio século ele ora sempre, e sempre antes das 5 horas da manhã. Nem eu, nem nenhum dos que o criticam somos dignos de amarrar seus sapatos! Sua grande e insuperável e ininterrupta liderança tem raízes no amor — e na paz, que é a harmonia do amor.

LONGANIMIDADE

A longanimidade é a resistência do amor. O significado da palavra neotestamentária aqui vertida como longanimidade é “suportar r.nrq temneramentn sorann”. A pessoa longâníma é paniprifp Ela encarna as palavras do apóstolo Paulo em 1 Coríntios 13: “... amor é paciente, é benigno.”.

O Dr. Han diz: “Quando se perde a calma, perde-se tudo”. Como isso é verdade! Eu recomendo que todo líder leia, releia e decore 0 poema de Rudyard Kipling “If” (“Se”). Começa assim: “Se és capaz de manter a calma quando todo mundo em redor já a perdeu e te culpa...”

Qualquer líder “capaz” possui um temperamento forte. Q líder efini°ntp apniarln am Dmis,. controla srii tRmpprampntn Por pior que seja uma provocação, 0 líder eficiente nunca se rebaixa para replicar, com presunçosa complacência, cortesia mundana, menosprezo paternalista, nem com revide agressivo. Ao contrário, responde com a paciência do amor — brandura.

BENIGNIDADE

A henignirlnde é n QprviVn Wn nmny O termo original do Novo Testamento que designa “benignidade” não se refere a sentimento mas a servinn. a prestar aiuda em neauenas coisas — fazflr ns pagnanag tflrpfgp que ajudam. reanimam p raconfnrtam OS OlltrOS. A_bfínigriirlgr,f> Ó n gar-vign dq «mnr Quando eu era adolescente, costumava ouvir o maravilhoso pregador Dr. Walter A. Maier, no programa de rádio “Levando Cristo às Nações”, da Hora Luterana. Todos os domingos sentava-me diante do rádio cativado pelo maior pregador radiofônico da terra. Com muita dificuldade arranjei dois dólares e os remetí a ele com uma carta. Pedia desculpas por mandar uma oferta tão pequena, mas dizia-lhe que era tudo que tinha. Dei-lhe certeza de minha fiel “audiência” à sua irradiação e de minhas fervorosas orações por ele e por seu ministério.

Alguns dias depois, fiquei atônito quando recebi dele uma carta datilografada de duas páginas. Não era uma carta “mimeografada”. Ele, pessoalmente, a datilografara. Uma secretária não iria errar tanto! Ele respondeu minha carta detalhadamente. Disse-me como era importante a minha oferta. Animou-me dizendo que “cada dólar alcança 1. pessoas com o evangelho através do nosso programa, assim sua oferta alcançará 3. pessoas!” Contou-me algumas perspectivas pessoais e incidentes. Em meu êxtase, disse a mim mesmo: “QuandíLSil crascar—sa_alguém me escrever, pprm tãn-bnnigjifjpare nnm p.la-cnmn rt Tlr TUnipr n fni para-^nmign’’
...
A Bíblia diZ que ripna n ahnnrlfliita om.hnnHarip V. a hnndade-á-naractfiriRtir.e de um líder forte,. Ela revela a força que se opõe a tudo que é mau e imoral. Ela faz com que o líder que imita a Cristo viva na dependência de Deus. Essa pessoa pede a Deus:

• a disposição de odiar o que é mau, • a vontade de seguir o que é reto, • sabedoria para julgar retamente em tudo, • amabilidade e sensibilidade intensas ao lidar com todas as pessoas.
...
O amor é o pai da bondade, pnrJ:«ntnr ela só fnnninna nq área-da-beneficência e dn auxílioA tjnndade encontra gn a. âncora nn amar não nn lapalismo. nem no “capachiqmo”. Nem o legalista, nem o bajulador oferecem beneficência ou socorro.

O legalista impõe sua dita “bondade” a outros. Assim o militar severo, sempre pronto para saltar com a crítica contra todo aquele que diverge do que ele considera o comportamento “próprio”, apropria-se indevidamente da liderança.
...
Fidelidade é o desafio de Savonarola aos abatinados interesses de Florença, Itália, em sua proclamação da verdade. Foi enforcado e seu corpo queimado, mas sua liderança perdurou por centenas de anos depois de sua morte. Esse é o poder da fidelidade na vida de um líder.
...
A liderança exercida em amor funciona! E o líder se dando aos outros para levar-lhes beneficência e ajuda. A liderança firmada sobre essa base nunca irá fracassar.$conteudo$,
      audio_leitura_url = null
  where curso_id = v_curso_id and ordem = 4;
  -- 5. O Princípio da Humildade
  update public.aulas
  set conteudo =
...
Parafraseando as palavras de A. W. Tozer em seu livro À Procura de Deus, — o homem humilde não é uma espécie de camundongo humano, sofrendo com o senso da sua própria inferioridade. Em sua vida moral, ele pode ser tão audacioso como um leão e tão forte como Sansão, mas não se engana a seu próprio respeito. Ele aceitou a avaliação divina a respeito de sua própria vida. Sabe que é fraco e impotente, como afirma. Paradoxalmente, ele se firma na certeza de que, à vista de Deus, ele é mais importante do que os anjos. Em si mesmo, nada é; em Deus, ele é tudo. Esse é o seu lema motivador. Não fica preocupado pelo fato de o mundo jamais o ver como Deus o vê. TranquilamPTpp permite—que Deus determino sens.valores pessoajs. O homem humilde espera pacientemente o dia em que cada coisa terá n seu precn marcado, e seu valor real. Epgnantn isso vai everoondn pna liderança para o benefício da humanidade a para a glftria de Peus. aleeremente disposto a esnerar o dia da qvajiação final.

A humildade — ou mansidão — é a expressão do amor. E a atitude de espírito e a disposição predominantes do amor. A pessoa humilde está livre do orgulho ou da arrogância. Submete-se aos outros e ê prestativa e cortês. O humilde não se considera auto-suficiente, todavia reconhece seus próprios dons, recursos e realizações. Sabe que foi objeto de um amor redentor, que não merecia. Portanto não pode confiar em si mesmo porque sabe que é “tudo de graça”. Mas, ser humilde nãn exclui tpr-rnnfianna, poisa Escritura nos diz“Nãn qhpurlnuRÍR pqrtnntni a-™c<!a mnfíapçp " (Hb 10.35.)

Quem é humilde não se ofende nem revida. Volta a outra face àquele que o fere. E, ua entanto, humildade uão e covardia,.nornuB-exipe prande coragem. A humildade nos leva a aceitar um lugar inferior àquele que merecemos, a silenciar a respeito de nossos méritos, a tpjarar Hosfnitas. insultos r acusações falsas nor-causa de um propósito superior. Tesns demnnQtrmi lmmilrlqp|p porque.“■■■ quando ultrajaria nãn roírirlgva anm ultraje: quanto maltratado nãn fazia ameaças”.
...
A humildade é o senso de incapacidade que permeia a consciência do líder quando ele contempla a santa majestade e o superabundante amor de Deus em contraste com sua desvalia, culpa e total inaptidão, se separado da graça divina. Esse é o tipo de humildade que Cristo aprecia. E a humildaria que fa? mm que a religião nqn seja rígida num negada, nem nompnsa mas simples, descontreírlp, àle^ra honrando a Deus e mostrando-se útil às nessnas.

Conquanto seja difícil para a maior parte das pessoas demonstrar humildade, para um líder isso é ainda mais difícil porque sua forma de vida não favorece a humildade. A maior parte dos líderes tem um papel cerimonial a desempenhar. Cabe-lhe receber e entreter dignitários visitantes. E ele quem representa seus seguidores nos eventos oficiais. E através da honra dada a um líder que o grupo também recebe honra. Quando o Primeiro-Ministro Rajiv Gandhi recebe atenções, honrarias e respeito, numa visita oficial a outro país, toda a índia está recebendo essas atenções, honrarias e respeito. Por causa disso, não é fácil a um líder demonstrar humildade. E, no entanto, a humildade é um princípio de liderança extremamente importante.

Podemos até negar-nos a escrever acerca da humildade, ao constatar que mesmo a argumentação em favor da humildade pode induzir-nos ao orgulho. Pode-se dizer que assim como uma pessoa honesta não fala de honestidade, nem a pura fala de pureza, também a humilde não discute a humildade, pela simples razão de que a humildade não possui consciência de si mesma. A hnmilriadp 6 n “nlha-gnp vê t.nrln nmnqs a si própria”, de flnnrdr. nnm ^ifonViT Alguém perguntou a Dwight L. Moody: “O senhor está dizendo que a pessoa humilde não pensa muito acerca de si mesma?” Moody respondeu: ‘‘Não; digo qne a pessoa humilde não pensa nem um pnnco ^ohra. si mesma. _Q jpimiidft nãn sloLp qne é tmmilrje ”

A FALSA HUMILDADE

Ainda pior que a falta de humildade é a falsa humildade que leva uma pessa a se sentir muito orgulhosa de estar agindo de modo humilde. O escritor e poeta inglês Samuel Taylor Coleridge disse que “o pecado mais apreciado pelo diabo é o orgulho que imita a humildade”.

E, no entanto, aquele que possui a falsa humildade está enganando apenas a si mesmo, porque os outros vêem nele uma pessoa pomposa, auto-aduladora e arrogante que, na realidade, apenas finge ser humilde. A pessoa verdadeiramente humilde evita atitudes forçadas. Não procede como os que estão sempre dispostos a ocupar o último lugar da mesa do banquete, desde que possam chegar atrasados para que todo o mundo os veja ocupando esse lugar.
...
“Quem há semelhante ao Senhor nosso Deus, cujo trono está nas alturas; que se inclina para ver o que se passa no céu e sobre a terra?” (SI 113.5,6.)
...
Conheço duas senhoras que ilustram bem esse contraste. Uma é médica e, embora possua uma grande riqueza e possa viver uma vida despreocupada e farta, preferiu entregar-se ao trabalho, servindo a milhares que estão doentes, sofrendo, em lugares distantes da casa dela. Vive em constante perigo. Mas a serenidade que há em seu coração se revela em seu rosto e comportamento. Sofre desfeitas e selvageria, repúdio e perigo. Mas continua, não desiste, nem se entrega à autopieda-de. F.la. realmente. se alognc polpc oportunidades que tffln de servir a outros. Com cinco minutos em sua presença, até o mais casual observador nota tanto a sua humildade quanto a serenidade resultante.
...
O líder que é humilde não age como se fosse auto-suficiente e não precisa se dar ares de que sabe tudo, e por isso se acha numa posição em que recebe opiniões e ideias de outros. Mas aquele que não tem humildade e se mostra auto-suficiente, não aceitaria quaisquer ideias; tal pessoa restringe-se ao seu pequenino mundo particular. Em vez de resultar numa atrofiadora negligência da personalidade, a humildade abre a porta para a expansão da personalidade e da individualidade.
...
A serenidade, ampliação da vida, eliminação do medo, sucesso e acessibilidade, todos decorrem da humildade. E ainda há outros frutos dela. O ponto a se lembrar é que a humildade não leva à supressão de nossa personalidade e ao abandono de metas conquistadas. Nem sufoca a liderança. Ao contrário, a humildade é o meio pelo qual podemos desenvolver nossa personalidade, e atingir, com o poder de Deus, as metas que ele nos deu e ampliar nossa liderança. /q % COMO SE CULTIVA A HUMILDADE? f ^ Se alguém quiser emagrecer cinco quilos, fará um regime. Se quiser ficar mais junto do Senhor, passará mais tempo em oração e no estudo da Palavra. Se quiser ficar mais versado sobre a história do Egito, lerá livros e procurará ouvir palestras a respeito do assunto. Mas, como se pode ficar mais humilde? Parece que falar acerca da humildade nos torna menos humildes — e não mais humildes — pois a humildade não possui consciência de si mesma.

E possível desenvolver a humildade, mas temos que fazê-lo indiretamente. Precisamos, primeiro, reconhecer os caminhos que levam à humildade e, dfjpois, concentrar-nos neles, e não na própria humildade. Assim a teremos. Mas, se nos concentrarmos nela, será impossível consegui-la.
...
Um exemplo: em 2 Timóteo 2.24,25, Paulo diz: “...servo do Senhor não viva a contender, e, sim, deve ser brando para com todos, apto para instruir, paciente; disciplinando com mansidão os que se opõem...”
...
Cristo demonstrou humildade na escolha de seus seguidores e amigos. Ele não foi ao “Quem é Quem” da Palestina para selecionar os que escolheria como discípulos. Aliás, em 1 Coríntios 1. e 27, Paulo diz: “...não foram chamados muitos sábios segundo a carne, nem muitos poderosos, nem muitos de nobre nascimento; pelo contrário, Deus escolheu as coisas loucas do mundo para envergonhar os sábios, e escolheu as coisas fracas do mundo para envergonhar as fortes”.
...
“Onde está o carregador para pegar minha mala?”
...
O amor e sua disposição — a humildade — são princípios essenciais de uma liderança verdadeiramente cristã. E não são muito encontrados naqueles que não têm essa liderança. E por isso que o seu cultivo é tão essencial. Estes princípios distinguem o líder cristão de outros. Somente aquele que assume uma posição de servo e deixa Cristo derramar continuamente seu poder nele, está capacitado para exercer uma influência toda especial sobre um grupo, de modo a conduzi-lo a metas de permanente benefício que atendem às reais necessidades do grupo.

O professor Dr. Eliseo Pajaro, de Manilha, Filipinas, que faleceu a 6 de outubro de 1984, era uma pessoa assim. Desde a meninice, Pajaro revelara um talento musical excepcionalmente promissor. Ao crescer, tor-nou-se um homem muito simpático, criativo e profundamente espiritual. Obteve seu PhD na Escola Eastman de Música em Rochester, N. Y., e, não muito depois, alcançava a cátedra na Universidade das Filipinas.
...
A humildade é a expressão do amor. E o senso de inferioridade que permeia a consciência do líder quando ele contempla a santa majestade e o superabundante amor de Deus em contraste com o seu próprio desmereci-mento, sua culpa e sua total desvalia, que é sua condição sem a graça divina. A pessoa humilde está livre do orgulho e da arrogância. Antes, coloca-se em posição de submissão a outros, e é prestativa e cortês. O humilde não se considera auto-suficiente e, todavia, reconhece seus próprios dons, recursos e realizações. Tanto o amor como a humildade são características do verdadeiro líder.

Pior ainda que uma pessoa não ter humildade é ter falsa humildade, com a qual ela se sente orgulhosa por agir de modo humilde. Quem tem falsa humildade está enganando apenas a si mesmo, porque os outros percebem que é pomposo, auto-adulador e arrogante, fingindo-se humilde. Em todos os tempos a verdadeira humildade sempre foi rara. Os discípulos de Cristo, por exemplo, nem sempre exibiram essa qualidade.
...
Falar acerca da humildade não nos torna mais humildes — e, sim, menos —, pois quem é humilde não tem consciência disso. Portanto, para ter humildade devemos concentrarnos em outros caminhos que levam a e-la. Entronizemos Cristo em nosso coração. Vivamos uma vida de obediência a Deus e à sua Palavra. Assumamos a atitude e o comportamento de uma criança. Sigamos o exemplo de Cristo na oração, nas relações pessoais, evitando o elitismo, a intolerância, a distinção de classes e a autopromoção. Sirvamos os outros.
...
Antes de Clifford morrer, o Dr. Carl E. Bates, um líder cristão, visitou-o e procurou ajudá-lo. A Dr.a Ernestine Smith, uma cirurgia da Igreja de Bates, tinha feito uma cirurgia exploratória em Clifford e sabia que ele estava à morte. Ela pedira ao seu pastor para visitá-lo.
...
O líder percebe a necessidade de ficar só porque o contínuo contato com seus liderados o enfraquece. Ele poderá cair para o nível deles. Poderá fazer concessões aos seus hábitos e fantasias. Em vez disso, ele deveria ajustar o desenvolvimento espiritual do seu caráter de modo a colocar-se ao nível de Deus. Ficar ao nível do grupo é muito mais fácil e mais confortável do que situar-se acima dele; mas isso impediría o atendimento das mais altas necessidades do grupo dando-lhes uma visão que resulte em mudanças de permanente benefício.

E na solidão que reconhecemos nossa necessidade de Deus, e nos fortalecemos. Mas a solidão requer autocontrole. A sós com Deus em um deserto, João Batista viu as coisas mais importantes — e as viu na verdadeira perspectiva. Jamais ficou embriagado com a fama. Ele conhecia sua missão. Conhecia sua relação com o Messias esperado. “Convém que ele cresça e que eu diminua.” Ele pagou o preço do autocontrole, que é o domínio do amor, para vir a exercer uma influência especial que levou as multidões a satisfazerem as reais necessidades delas.

O verdadeiro teste da coragem e da capacidade do líder de ficar só ocorre em tempos de crise. Numa crise, os subterfúgios, as frases de duplo sentido e o exibicionismo nada valem. E em tempos de crise que o autocontrole é mais necessário ao líder, pois a ausência do domínio próprio só serve para agravar ainda mais tais situações.
...
E provável que nenhum outro estrangeiro tenha exercido uma liderança mais sensível sobre o povo de Shaoh-sing, China, no princípio do século XX, do que o Dr. Claude H. Barlow. Esse discreto médico missionário era a personificação do autocontrole.
...
Quando lhe perguntaram acerca de sua experiência, o Dr. Barlow simplesmente respondeu:

“Qualquer um teria feito a mesma coisa. O que aconteceu foi que eu estava em posição vantajosa e, assim, tive a chance de oferecer meu corpo.”
...
E com esse tipo de liderança que o líder conquistará seguidores.
...
Encontramos ajuda para desenvolver e exercitar o autocontrole refletindo sobre o que Deus já operou em nós. A misericórdia que Paulo recebeu de Deus, por exemplo, motivou-o a exercer autocontrole. Como podería desalentar-se com os outros se ele mesmo alcançara tal misericórdia? Como poderia abandonar o caminho traçado se a mesma graça, pela qual fora salvo, lhe era dada abundantemente para guiá-lo e sustentálo? Como poderia tornar-se impaciente com outros quando refletia acerca da longanimidade divina que tinha pairado sobre ele e tinha aniquilado sua rebeldia? A bondade de Deus constitui um poderoso incentivo para o aUtOCOn-trole...p*~ ia.
...
Imaginemos como iremos agir, sendo um líder que possui autocontrole. Como reagiremos em relação a pessoas em diversas situações? Como o autocontrole contribuirá para nossas metas e missão? Imaginemos nosso grupo, como achamos que estará daqui a um ano ou daqui a três anos? Criar essas imagens claramente no pensamento ajuda-nos a pô-las em prática. Além de nos enxergarmos em situações ideais, é bom também rememorar, em detalhes, as situações nas quais já exercitamos^ autocontrole.

E assim que se treinam os atletas. O treinador lhes diz para relaxarem e visualizarem seu melhor desempenho — como se sentiram, o que ouviram, odores que notaram, o sabor da água ou do pó ou do ar, o que eles viram. São instruídos a gravar no cérebro todas essas impressões de grande riqueza sensorial de modo que em competições futuras eles possam reproduzir e até melhorar seu desempenho. Os melhores vendedores e oradores do mundo vêm fazendo isso há anos.
...
Mas é preciso experimentar essa liberdade para apreciá-la de fato, pois o mundo está sempre dizendo que a liberdade vem, não do autocontrole, mas da satisfação dos próprios desejos. Na realidade, a auto-satisfação leva à escravidão, enquanto o autocontrole nos conduz à liberdade.
...
— Estou convencido de que tem inteligência, sensatez, o atrativo, mas^ não estou certo de que tenha bastante entusiasmo. E um homem brilhante e educado, o tipo que a gente gostaria de ter como amigo, mas não tenho certeza se ele tem estômago para a intrincada luta da política.
...
Um dos mais importantes princípios da liderança eficiente é, certamente, a do autocontrole. Comece a desen-volvê-lo hoje mesmo em sua vida.
...
O líder semelhante a Cristo sabe que o autocontrole é importante porque a ausência dele destrói a liderança. O líder precisa ser muito cuidadoso com a falta de autocontrole principalmente nas áreas onde é o mais forte, tem a maior influência, e se sente mais seguro. E aí, exatamente, que o problema desponta. O autocontrole nos dá coragem para nos posicionarmos sozinhos. Ajuda o líder a não se desviar de sua visão, seguindo as opiniões e sutis pressões da sociedade. O autocontrole conquista seguidores para o líder. As pessoas desejam seguir aqueles que demonstram autocontrole.
...
O autocontrole é tido, geralmente, como uma restrição, uma disciplina que resulta numa existência dura e infeliz. Na realidade, porém, a verdade é justamente o oposto. O autocontrole produz, em qualquer pessoa, qualidades que farão dela um candidato à liderança. O autocontrole produz liberdade, confiança, alegria e estabilidade. Essas qualidades elevam quem as possui à posição de liderança.$conteudo$,
  ...
  -- 7. O Princípio da Comunicação
  update public.aulas
  set conteudo =
$conteudo$A liderança começa com uma visão. O comprometimento com aquela visão é uma missão, que ê, então, cumprida pelo estabelecimento de certas metas. Mas o líder não faz isso sozinho. Sua tarefa é comunicar a visão, a missão, e as metas aos seus seguidores, tudo com amor e humildade.
...
“O que pode ser mais fácil do que comunicar?” podería perguntar alguém. “Eu faço isso todos os dias.”
...
Em termos mais simples, a comunicação ocorre quando uma mensagem é transmitida de uma pessoa a outra, e ambas compreendem a mensagem, aproximadamente do mesmo modo. Mas há um grande número de barreiras a uma comunicação eficiente. Suponhamos que uma pessoa X deseja dizer alguma coisa a Y. O diagrama20 abaixo representa a comunicação de X com Y.

A pessoa X deseja que a sua mensagem tenha um certo efeito em Y. Talvez ela esteja compilando uma lista de endereços e esteja com alguns dados errados. X deseja que o Y corrija o engano. Então usa algumas palavras para dizer a Y que a lista está incorreta e o que ela deve fazer para corrigi-la. O termo técnico que designa essas palavras é “codificação”. A mensagem codificada tem um conteúdo pretendido (a lista está errada) e um efeito pretendido (que Y a corrija). A seguir, X transmite a mensagem a Y através de um canal. Talvez ele fale a Y, ou talvez lhe escreva um memorando. Então Y decodifica a mensagem para tomar conhecimento do conteúdo que X está tentando comunicar-lhe. A eficiência da comunicação será avalidada pelo grau de semelhança entre o conteúdo percebido e o pretendido, e entre o efeito real e o pretendido.

E importante que o líder reconheça que a eficiência da comunicação será dada pelo conteúdo percebido e pelo efeito real — não pelo seu conteúdo pretendido, por mais eloquente que a transmissão dele tenha sido, nem pelo efeito pretendido, por mais puras e nobres que sejam suas intenções. E tarefa do comunicador verificar se o conteúdo percebido e o efeito real estão certos; e não apenas supor que o conteúdo foi compreendido e o efeito conseguido.

A percepção que Y terá do conteúdo e, por conseguinte, o efeito real, dependem de muitas outras coisas além das palavras. Se X fala swahili e Y entende só japonês, é óbvio que a mensagem não será comunicada. Se a sala está tão barulhenta que Y não pode compreender o que X lhe diz, é possível que ele sorria educadamente e mais nada. O efeito pretendido não é conseguido. Se Y acaba de saber que seu pai faleceu, e se teve outros problemas naquele dia, ele pode irritar-se com X. Assim também, o efeito pretendido não é alcançado. Além de suas palavras, X pode comunicar muito por seu comportamento não verbal — sua postura, sua expressão facial, o lugar onde coloca as mãos.

A comunicação eficiente é uma arte e uma ciência. E uma arte que requer a mesma atenção intensa, a mesma prática persistente e a técnica cuidadosa necessárias ao domínio da pintura, da escultura ou da música. E uma ciência baseada em princípios da Psicologia.
...
A comunicação eficiente tende a salvaguardar a liberdade de expressão.
...
A comunicação eficiente apresenta condignamente os pensamentos dignos.

Uma suposição muito comum entre as pessoas é a de que precisamos apenas “ter alguma coisa para dizer” para estar em condições de comunicar. Que horrível falácia! Se essa “alguma coisa para dizer” não for comunicada eficientemente, será o mesmo que soltar palavras ao vento. Ter interesse somente no que está sendo dito é focalizar a atenção no conteúdo pretendido e no efeito pretendido da comunicação. Eles são importantes, mas um comunicador eficiente, em vez disso, focaliza mais o conteúdo percebido e o efeito real.
...
O líder eficiente não deixa nada ao acaso. Embora esteja aberto à iluminação do Espírito Santo, ele prepara sua comunicação verbal tão cuidadosamente quanto um regente de orquestra prepara sua comunicação musical. Não basta ter pensamentos valiosos. E preciso que eles sejam comunicados condignamente.

Se todas as comunicações fossem proibidas, o progresso seria tragicamente travado. As rodas da industria iriam parar com um ranger de engrenagens. As escolas fechariam as portas. Os governos entrariam em colapso. As famílias desintegrar-se-iam. As alianças se desmembrariam. A fome dizimaria a humanidade em todo o globo. E como a evangelização do mundo sofreria se toda comunicação fosse proibida!
...
Quando nossa meta é informar, isso significa que faremos com que outros compreendam algo. Essa é a meta de todos os que procuram transmitir informação puramente como informação. Nesse caso, o comunicador terá cumprido seu objetivo quando apresentar as ideias de modo que o auditório possa compreendê-las claramente. Essa ê a meta de uma testemunha num tribunal. E a grande função de um dicionário. Quando “informar” é a meta, apresentamos as ideias e ficamos só nisso. Não apresentamos tendências, nem opiniões.
...
Devemos perguntar-nos vez por outra: “Como me sentiría a respeito disso se eu estivesse no auditório?” Compreendería este ponto com a base que eles têm? Isso me parecería razoável se tivesse passado pelas experiências deles? Seria interessante para mim se eu fosse um deles?”

Há vários fatores a serem considerados acerca das experiências das pessoas. Primeiro, temos a tendência de lembrar as impressões que foram intensas inicialmente. Em 1975, em Teerã, cheguei a curvar-me por causa de uma dor provocada por uma pedra nos rins.

Mas se contasse essa experiência para falar de dor, a maior parte das pessoas não se identificaria comigo, já que são poucos os que já sofreram uma crise de pedra no rim. Mas a maioria já teve uma dor de dente. Então, posso usar a experiência de uma dor de dente para comunicar a ideia de dor com muito mais sucesso do que a de um corte num dedo, por exemplo, porque uma dor de dente é muito mais intensa.
...
As ideias abstratas tendem a cloroformizar a atenção das pessoas. Ou, pior, elas frequentemente resistem totalmente às ideias abstratas. As pessoas de um modo geral não crêem numa declaração a menos que haja provas. E não passam à ação seguindo uma orientação a não ser que esta tenha um suporte lógico e emocional.

Um vendedor de computadores pode dizer-me que preciso de um processador de palavras em meu gabinete em casa. Discordo. “O custo é proibitivo”, argumento.

“Não tenho espaço. E não sei usar o aparelho.”
...
É pouco provável que, com uma simples informação, mudemos a mente de uma pessoa, consigamos sua devoção em relação a um novo conceito, ou a levemos a contribuir para uma causa digna. Precisaremos empregar uma sucessão de declarações sutentando o mesmo ponto. Acumulação significa “empilhamento”. E uma progressão de pensamentos. Fortalece as informações dadas, oferecendo provas adicionais.

Se eu disser: “Muitas pessoas com mais de sessenta anos realizaram grandes feitos”, o auditório pode pôr em dúvida a afirmação. Mas passarão a concordar comigo se usar a acumulação falando de Benjamim Franklin que, com mais de oitenta anos, foi embaixador na França; de Gladstone, que foi primeiro-ministro da Inglaterra aos oitenta e três; de Chiang kai-shek, que governou a República da China quando estava com mais de oitenta; e de Verdi, que escreveu óperas aos oitenta.
...
Poderiamos dizer, por exemplo: “A universidade em que estudei é uma boa escola. Dela estão saindo hoje alguns dos melhores técnicos do país nos campos da “robótica”, da engenharia genética, do estudo aeroespacial e na ciência da computação.” A afirmação acerca da qualidade da universidade é elucidada pela ilustração geral que vem a seguir. Mencionamos a robótica, por exemplo, mas não citamos nenhum nome específico nesse campo.
...
A autoconservação é o desejo básico que nos induz à maioria das ações. É por ela que comemos e bebemos. E por ela também que se recrutam exércitos e organizam-se forças policiais. Por ela exige-se controle no escapa-mento dos automóveis e a proteção do ambiente por parte da indústria.
...
O poder se relaciona com o desejo de possuir habilidade, força e energia. E o anseio de ter capacidade para ser alguma coisa e realizar certas coisas. Nele está incluído o desejo de ter força (moral e física), autoridade e influência. Nessa categoria encontramse quase todos os sonhos e anseios pessoais.
...
Esse desejo é muito forte. Alguns homens preferem até arriscar a vida do que perder uma boa reputação. E esse desejo que transforma um indolente em trabalhador, o avarento em generoso, e o enganador em honesto.
...
1. Reconhecer a importância da comunicação eficiente. O líder deve preocupar-se não apenas com as palavras que diz, mas com o conteúdo que seus ouvintes captam, e com o efeito que o conteúdo tem realmente como resultado de sua comunicação. A tarefa do líder é promover essa compreensão. A comunicação eficiente supera o problema do alheamento e é um fator de reprodução, tende a garantir a liberdade da palavra e apresenta pensamentos valiosos de forma proveitosa.

2. Avalia o auditório. A base para que todas as outras regras da comunicação eficiente funcionem é a avaliação dos ouvintes. Temos que conhecer suas características demográficas, avaliar sua atitude para com a circunstância em que vivem e questões importantes, e a atitude dos ouvintes uns para com os outros. Temos que avaliar também a atitude do auditório para conosco e com o assunto que abordamos.
...
5. Fazer referência ao conhecido, à experiência do auditório. Só conseguiremos desenvolver a credibilidade do auditório fazendo referência às experiências dele. Para isso, devemos adquirir um repertório de experiências vividas gerais, comuns à média das pessoas que lideramos. Um certo número de fatores torna essas experiências mais memorativas: a intensidade delas, as vezes em que são repetidas e recordadas, e a proximidade no tempo.
...
7. Motivar o grupo à ação por meio do apelo aos anseios pessoais. O líder quer ação. Quer efetuar mudanças. O modo mais eficiente de se conseguir isso é apelar aos anseios dominantes do auditório particular. O líder deve apelar aos interesses do seu auditório, que podem ser expressos em necessidades de autoconserva-ção, propriedade, poder, reputação e afeição. Quem não conseguir induzir outros a agir, nunca chegará a ser líder, e ninguém pode induzir outros a agir se não tocar nos anseios básicos do ser humano.

A comunicação deve ser um estudo constante, um profundo interesse, uma disciplina para a vida inteira. Através de uma comunicação eficiente poderemos superar outros que talvez sejam mais inteligentes ou tenham melhor aparência, mas que não desenvolveram toda a sua capacidade de comunicação.$conteudo$,
      audio_leitura_url = null
  where curso_id = v_curso_id and ordem = 7;
  -- 8. O Princípio do Investimento
  update public.aulas
  set conteudo =
...
Robert W. Woodruff morreu com a idade de 95 anos, quando eu estava escrevendo este livro. Ele não somente elevou a Coca-Cola às dimensões de um gigante internacional, mas também influenciou a educação, as artes, a política, o serviço social e a expansão do cristianismo.

Entre outras doações, fez a maior contribuição feita por um indivíduo a uma universidade: 105 milhões de dólares doados à Universidade Emory, em Atlanta, Geórgia.
...
Mas, se o grupo perceber que estamos procurando nosso auto-engrandecimento, perderemos a influência que agora temos para conduzir seus membros para as metas de permanente benefício que atendem às reais necessidades deles. É que porão em dúvida a validade das metas que estabelecemos, pois duvidarão de nossa motivação.

Os presbíteros da igreja do Dr. Han, na Coreia, me contaram que ele recebia o pagamento às sextas-feiras, mas que, muitas vezes, antes de chegar em casa, já tinha dado tudo para os outros. Afinal, passaram a entregar o dinheiro à Sr.a Han, de modo que ela pudesse pagar as contas e comprar mantimentos! Essa prática do Dr. Han de dar confere à sua liderança uma credibilidade e permanência que os líderes que promovem o engrande-cimento próprio jamais atingem.

Mas, mais do que compreender o significado do investimento e praticá-lo, cabe a nós instilá-lo nos membros de nosso grupo. Como resultado do exemplo, do ensino e da experiência vicária de ver-nos colher de acordo com o que semearmos, as pessoas deveríam chegar a praticar também o princípio do investimento.

Em seu livro tremendamente popular, In Search of Excellence (Em busca da excelência), Thomas J. Peters e Robert H. Waterman, Jr., analisam o que é que torna uma empresa excelente. Entre os oito fatores que mencionam há um que ilustra o princípio do investimento: “As empresas excelentes são aquelas que se aproximam do cliente”. Tais companhias têm o máximo cuidado no que diz respeito à qualidade, confiabilidade ou serviço. Estão empenhadas em considerar o cliente importante, oferecendo-lhe o melhor produto possível pelo dinheiro que paga e prontificando-se a servi-lo naquilo de que ele precisar. E essas firmas excelentes colhem o que semeiam conquistando a lealdade do cliente bem como vendas a longo prazo e aumento dos lucros. Para ilustrar isso Peter e Waterman contam a história da Frito-Lay, uma companhia de batatinhas fritas e “palitinhos”:

“O que é notável em relação à “Frito” não é o seu sólido sistema de administração, nem o seu excelente programa de publicidade. O que é notável é seu corpo de vendedores de quase 10. pessoas, e “um atendimento que chega a 99, por cento”. Em termos práticos o que significa isso? Isso significa que a “Frito” chega a fazer coisas que, a curto prazo, são claramente anti-econômicas. Despende centenas de dólares para enviar um caminhão para recompor o estoque de uma loja onde faltam apenas uma ou duas caixas de batatinhas fritas no valor de $30, dólares. Pode parecer que ninguém ganha dinheiro desse modo. Mas a companhia está cheia de casos de vendedores que enfrentam as piores intempéries para entregar uma caixa de batatinhas ou mesmo para ajudar uma loja numa limpeza após um furacão ou um acidente. Cartas narrando tais fatos jorram na matriz da empresa, em Dallas. Esse cuidado no atendimento tem consigo certo simbolismo e magia que não podem ser medidos em termos de quantidade. Como dissemos antes, isso constitui o alvo preferido por qualquer analista de custos. Afinal, sempre se pode encontrar maneiras de economizar dinheiro reduzindo um ou dois pontos percentuais nesses custos. Mas a administração da “Frito”, considerando sua participação no mercado e as suas margens de lucro, não quer definitivamente, não pensa em esfriar o entusiasmo de seus vendedores.”
...
Se um líder quiser criar alegria nas pessoas de seu grupo, pode consegui-lo motivandoas a adotar o princípio do investimento como a lei básica de sua vida. Mas, para isso, ele tem de compreender a motivação certa para o investimento. Ele sabe que seu grupo agirá quando tiver razão para isso. Para motivar as pessoas a gozarem a ampliação de vida resultante do investimento ele precisa oferecer-lhes uma motivação muito forte.

Fazer caridade, emocionalismo, competição, busca de reconhecimento e sentimento de culpa não se constituem em motivos adequados para dar. Funcionarão em certas ocasiões, mas não são automotivadores. O dever também é motivação legítima, mas geralmente falha porque multas pessoas não têm o caráter necessário para corresponder. Não há motivação maior do que a do amor. Não obstante, um líder sábio sabe que embora ele próprio lidere motivado pelo amor, para muitos do grupo, o amor é flutuante e tende a aumentar ou diminuir de acordo com as variações do altruísmo. Estivéssemos nós já no céu, indubitavelmente o amor seria a melhor motivação. Mas ainda somos pecadores.
...
Jesus disse: “Não podeis servir a Deus e a Mamom” (Mt 6. — I. B. B.). A palavra mamon representa as riquezas e bens materiais, não em maior ou menor quantidade, mas a existência deles em si. De acordo com Jesus, mamom é uma coisa pela qual nunca deveriamos estar ansiosos, por causa da qual nunca deveriamos ter preocupação, e pela qual não deveriamos sentir obsessão. Em vez disso, cabe ao cristão atender ao “buscai, pois, em primeiro lugar, o seu reino (de Deus) e a sua justiça, e todas estas cousas vos serão acrescentadas” (Mt 6.33). O líder ganancioso ou ansioso acabará destruindo-se.
...
Jesus nos adverte também contra a ganância, o desejo de possuir coisas. O cobiçoso camufla sua avareza tauiando-a de “prudência”, ou “bons negócios”, ou “planejamento sábio”. Deus a chama de cobiça — um insaciável desejo por lucros seculares, uma obsessão de ganhar sempre mais, uma preocupação em agarrar o que ainda não temos.
...
— Sr. Moody, será que só pode recorrer a mim quando precisa de dinheiro? O senhor tem muitos outros amigos ricos. Já dei 85. dólares para o seu trabalho.
...
E uma pena que nesses séculos todos tenhamos identificado a santificação com a pobeza. E verdade que devemos estar dispostos a ser pobres. E é muito possível que Deus tenha planos para nós dos quais não constam carros de luxo ou nem casas suntuosas. Mas, quer sejamos pobres ou ricos, tudo que possuímos vem de nosso Provedor, Deus. E nós temos a feliz obrigação de honrá-lo através do princípio do investimento, pelo qual também nos enriqueceremos.
...
Depois de falar de seu sofrimento e desventura, Jó disse:

“Aquilo que temo me sobrevêm, e o que receio me acontece.” (Jó 3.25.)

Jó temia o pior e foi o que lhe sobreveio.

Nossos temores e pensamentos negativos transfor-mam-se em profecias que se cumprem por si mesmas. Se alguém duvida de que alcançará suas metas de venda, é provável que não as alcance mesmo. Se um pastor tem medo de que sua nova igreja não o aceite, é provável que não aceite. Se alguém diz a uma criança que ela fracassará e nunca chegará a ser nada de bom, é provável que isso se concretize. E há muitas pessoas que vêem um copo pela metade e dizem que está meio vazio em vez de meio cheio. Não compreendem que “Deus não nos tem dado espírito de covardia, mas de poder, de amor e de moderação” (2 Tm 1.7).
...
Essa interpretação não passa de uma ilusória espiri-tualização. Por que o dinheiro é diferente do algodão ou da amizade?
...
Quando um agricultor planta a semente, não espera obter uma colheita no dia seguinte. Leva meses. Precisamos ser pacientes. O processo todo pode levar algum tempo. E possível até que tenhamos muitos problemas antes da colheita.
...
SEXTO MANDAMENTO Não Desanimar por Uma Ocasional Falha da Colheita. Só porque uma geada destrói a colheita de pêssego, será que o agricultor vai desistir de cultivar a fruta? Não! Ele sabe que obterá sucesso no plantio desde que obedeça às leis do cultivo de pêssego.
...
— “Não sei exatamente quando me tornei crente. Mas, lembro-me da primeira grande oferta que dei para » Instituto Haggai. Bem, eu acompanhei aquele dinheiro para ver onde estava sendo usado, e foi aí que me encontrei com Jesus Cristo. Não me lembro exatamente do dia, mas sei que ele é meu Salvador, e que continuo confiando nele.”
...
Talvez não tenhamos vontade de nos alegrar quando acabamos de perder dinheiro num mau investimento ou a bolsa de valores sofreu uma baixa de 1. para 900. Embora não possamos controlar nossos sentimentos diretamente, podemos controlá-los indiretamente, pelo controle de nossas ações e, algumas vezes, de nossos pensamentos. Se não nos sentimos do modo como deveriamos, podemos pensar e agir como deveriamos nos sentir, e logo estaremos sentindo do modo como estamos pensando o agindo.

Ninguém segue um queixoso. O queixoso, o lamuriento, nunca é dinâmico. Há dois tipos de pessoas: termômetros e termostatos. O “termômetro”, aquele que registra a temperatura do ambiente, sobe e desce como um ioiô. Reage de acordo com tudo o que lhe acontece. Do outro lado, o “termostato” regula a temperatura do ambiente. Quando sua personalidade radiante, manifestando a força de Deus, entra numa sala, é o mesmo que acender centenas de lâmpadas. E! Alegremo-nos! Que a alegria se reflita em nosso rosto. Façamos com que os outros, olhando para nós, percebam a alegria que dizemos estar em nosso coração.
...
Essa prática dará uma impressionante dimensão à nossa liderança. Pareceremos estar sempre no controle das circunstâncias, sempre em foco, cheio de energias, no controle de nós mesmos. Isso inspira confiança e lealdade.
...
Como todos os dons de Deus, o princípio do investimento é bom, mas pode ser usado para maus fins. Por esse motivo, Jesus nos adverte contra dois extremos que podemos adotar em nossa atitude para com o dinheiro. Ele nos advertiu contra a ideia de que o dinheiro é inerentemente mau, o que nos levaria a ficar excessivamente preocupados e amedrontados em relação às coisas materiais. Ele advertiu, também, contra o extremo de fazer dos bens matérias o centro de nossa vida e sermos cobiçosos ou termos o desejo de possuir apenas por possuir. O cristão não pode servir a ambos, a Deus e a Mamom, mas deve aprender a servir a Deus com o seu mamom”.
...
O princípio do investimento acha-se resumido nas palavras de Cristo: “Dai, e dar-sevos-á; boa medida, recalcada, sacudida, transbordante, generosamente vos darão: porque com a medida com que tiverdes medido vos medirão também” (Lc 6.38).$conteudo$,
      audio_leitura_url = null
  where curso_id = v_curso_id and ordem = 8;
  -- 9. O Princípio da Oportunidade
  update public.aulas
  set conteudo =
$conteudo$Nossas maiores oportunidades nos aparecem habilmente disfarçadas em problemas insuperáveis.

Na década de 1970, Lee Iaccocca era o presidente da Ford Motor Company com uma atuação dinâmica e vitoriosa. Ele tinha criado o Mustang, um carro que vendeu mais unidades no seu primeiro ano de existência do que qualquer outro carro na história do automóvel. Ele tinha levado a Ford a obter lucros em torno de 1 bilhão e 800 milhões de dólares por dois anos seguidos. Ganhava cerca de 970. dólares por ano e era tratado regiamente. Mas vivia à sombra de Henry Ford II, um homem que Iaccocca descreve como caprichoso e despeitado. A 13 de julho de 1978 Henry Ford o despediu.
...
No Egito, José foi lançado na prisão. Ele fugira da esposa de Potifar quando esta tentara seduzi-lo. Contrariado pela sua recusa em pecar com ela, acusou-o de a haver insultado e atacado. Agora, José estava na prisão na condição de escravo, num país estrangeiro. Os obstáculos que enfrentava pareciam insuperáveis. Mas Deus os transformou em sua maior oportunidade.
...
Mas depois percebemos que realizar os seminários iniciais do Instituto Haggai na Suíça foi um dos maiores erros que cometemos. A Suíça não era o local certo. Não tive outra escolha senão admitir o erro. Resolvi, então, assumir a responsabilidade por ele. Telefonei a um grande doador, que nos emprestara 100. dólares para lançarmos o programa, pedindo-lhe uma entrevista. Preferiría levar uma surra, a ter de falar-lhe, mas sabia que tinha de proceder assim.

— Por que não pode contar pelo telefone o que tem a dizer-me? perguntou ele.

— Para tratar desse assunto tenho que me sentar em frente de você e olhar em seus olhos, respondí.
...
Na avaliação dos prejuízos desse erro calculamos uma perda de 55. dólares em dinheiro, porque o dono da propriedade original voltou atrás em sua palavra. Havíamos assinado um contrato com ele, e, por isso, fomos aconselhados a processá-lo, mas a junta decidiu não seguir esse curso de ação.
...
Temos que fazer um rigoroso e minucioso auto-exame. Pôr a culpa nos outros é matar a liderança. Precisamos identificar o problema e solucioná-lo.
...
Examinemos se as informações de que dispúnhamos eram exatas. Em 1968, o veterano missionário Roy Rober-tson fez uma declaração a um grupo de líderes da Indonésia, que se fixou em minha memória: “Um gênio com informações inadequadas está em grande desvantagem em relação a um homem de mentalidade medíocre mas com boas informações.” E como ele tinha razão!

E preciso ver se o erro foi devido à falha de um trabalhador preguiçoso que deixou de realizar uma tarefa a tempo, ou de outro, com temperamento violento, que provocou discórdia entre aqueles que trabalham conosco, ou de ainda outro que não entendeu bem o que era para ser feito. Ao fazer essa verificação, entretanto, precisamos ter cuidado de não procurarmos um bode expiatório. Isso é contraproducente e anticristão. E ainda atuará negativamente sobre a equipe inteira.

Façamos uma análise profunda das possíveis causas do erro. Se o engano afetou bastante a nós e ao grupo, podemos conseguir que outros nos ajudem a achar as soluções, mas o exame e a avaliação deve ser feita pelo próprio líder.
...
Sexto, recuperar o que for possível. Faz alguns anos, uma companhia fabricou em excesso centenas de milhares de espátulas mata-moscas. Como não poderia arcar com as despesas de estocamento, resolveram contratar os serviços de um dos principais publicitários do mundo, Elmer Wheeler. Ele olhou para os mata-moscas, notou que eram quadrados, e sugeriu para promoção de vendas a seguinte frase:- “Estes matamoscas são quadrados para que você possa matar moscas nos cantos”. Em questão de poucas semanas todos os artigos tinham sido vendidos. Essa companhia agiu com bomsenso. Os serviços de Elmer Wheeler custaram-lhe uma fortuna, mas foi um sábio expediente, baseado em um risco calculado. O problema foi resolvido.

Sétimo, rever nosso modus operandi de modo que o erro não se repita, Devemos avaliar constantemente õ que fizemos para ver se podemos melhorá-lo — não apenas em relação a esse erro, mas em relação a todas as outras atividades. Isso requer constantes análises e autoquestionamentos.

O aprendizado perene assegura uma liderança produtiva. Aprendamos com os outros. Vamos ler biografias, ler jornais relacionados especificamente com nosso campo de atividade. Não importa quem somos ou onde vivemos, sempre podemos encontrar em livros e periódicos histórias de pessoas proeminentes que servem a Deus na nossa mesma área de atuação. Esses escritos revêem as falhas deles e suas realizações. Fico com o coração pesado quando converso com crentes que aspiram ser líderes e que ainda não aprenderam nada das Escrituras, que não leram, em média, cinco livros por ano em dez anos, e que nada fizeram para aumentar seus conhecimentos nem apurar suas habilidades.
...
Recebi de diversas fontes meu conhecimento pessoal de liderança bem como de outras áreas. Entre muitos outros, sou devedor a John Sung, da China, e James Chalmers, da Escócia; a Han Kyung Chik, da Coreia, e Jeseph Parker, de Londres; a Benjamin Moraes, do Brasil, e João Calvino, de Genebra; a Chandu Ray, do Paquistão, e Roland Payne, da Libéria; a João Wesley, da Inglaterra, e a Sam Arai, do Japão; a John Gladstone, do Canadá, e a Baki Sadaka, do Egito; a Martinho Lutero, da Alemanha e Neson Cornelius, da índia; a São Francisco Xavier, da Espanha e França, e a Reginald Klimionok, da Austrália; e a publicações tais como Korean Review (Revista Coreana), Asia Week fSemana da Ásia), Board fíoom Report (Boletim da Sala da Junta), Success (Sucesso) e Fortune (Fortuna). Note que essa lista cobre todos os continentes e abarca centenas de anos.
...
A oliveira, por outro lado, pode não ser bola om si mesma. Muitas vezes é retorcida e nodosa. Sua beleza está principalmente em sua fertilidade. Quando a árvore está carregada de azeitonas, até esquecemos a feia aparência do seu tronco e galhos, ao contemplar a beleza dos seus frutos. Assim ocorre ao apóstata restaurado: embora lamente a perda da beleza do lírio, pode alegrar-se com a beleza da frutificação da oliveira.
...
Os que demonstram um verdadeiro espírito sacrificial nunca dizem estar fazendo sacrifício. Os que lamentam seus pretensos sacrifícios têm uma opinião muito elevada a respeito de si mesmos. E que não cresceram.
...
Sétimo, revisar nosso modus operandi de forma que o erro não se repita. Avaliemos constantemente o que fazemos para ver o que pode ser melhorado, não apenas em relação a esse erro, mas em relação a todas as nossas atividades. Isso requer constantes análises e autoques-tionamentos.
...
Aqui se fazem necessárias duas palavras de advertência: primeira, o líder não deve tentar destacar-se, nem lamentar-se. Ele não deve se queixar de que estáse sacrificando. Segunda, tratar os obstáculos como se não existissem é fugir à realidade, e desonra a Deus. Os obstáculos existem.

Sob a direção de Deus, o líder deve desenvolver o hábito de, criativamente, converter os obstáculos em oportunidades. Esse hábito realçará nossa liderança, inspirando aqueles que nos seguem.$conteudo$,
      audio_leitura_url = null
  where curso_id = v_curso_id and ordem = 9;
  -- 10. O Princípio da Energia
  update public.aulas
  set conteudo =
...
Napoleão dizia que devia seu sucesso à juventude, à saúde e à capacidade de suportar esforços físicos ilimitados. Ele tinha a “capacidade de dormir a qualquer momento” e um estômago que podería “digerir qualquer coisa”.

Florence Nightingale, segundo diz seu biógrafo Ed-ward T. Cook, “permanecia de pé vinte horas seguidas, designando acomodações, distribuindo provisões, dirigindo o trabalho hospitalar ou ajudando em operações”.
...
Não se pode explicar a liderança de Napoleão, de Florence Nightingale ou de João Wesley sem levar em conta a inesgotável energia dessas pessoas. A mesma coisa se pode dizer do falecido Sir Bruce Small, antigo presidente da junta de diretores do Instituto Haggai [Austrália). Sir Bruce serviu simultaneamente como membro do Parlamento e como prefeito de Gold Coast, em Queensland, estando, ao mesmo tempo, à testa da maior empresa de desenvolvimento agrário de Queensland. Seu nome consta de The Guinness Book of World Records (O livro Guinness de recordes mundíaisj onde é citado como o homem mais idoso que já concorreu a um cargo eletivo e ganhou. Nessa ocasião ele estava com setenta e seis anos.
...
E importante enfatizar aqui que não é necessário que um líder goze de perfeita saúde para atrair outros pela energia demonstrada através da vitalidade física. Frank-lin Delano Roosevelt, por exemplo, não andava, pois tivera paralisia infantil, mas tinha energia e vitalidade ilimitadas, e foi a única pessoa que exerceu mais de dois mandatos como presidente dos Estados Unidos.
...
Quando a Segunda Grande Guerra terminou, o Dr.

Han Kyung Chik estava lecionando numa escola na Coreia do Norte. Ele notara o grande número de crianças que tinham ficado órfãs pela guerra; reconheceu a necessidade crítica de instalações escolares. Enxergou as áreas de serviço social necessárias para atender às necessidades das pessoas brutalizadas pelo conflito. Com sua aguçada capacidade de observação, chegou à linha de pensamento de sua liderança, pela qual ele tem conduzido o seu trabalho há mais de quarenta anos: evangelização, educação, serviço social.

O líder inteligente deve ter também a capacidade de fazer previsões, o que implica em preparo. Pela previsão, ele faz provisões para todas as emergências possíveis. Quando Roald Amundsen fez a viagem que resultou no descobrimento do Pólo Sul, levou consigo 97 cães selecionados no Alasca. Enquanto dirigia para o sul sobre barreiras de gelo, foi estabelecendo estações de suprimento. Marcou-as tão bem com sinais e bandeiras que, quando voltou, as encontrou, embora estivessem encobertas por densa neblina ou por camadas de neve recente. Ele se preparara meticulosamente para a expedição e percorreu os 560 quilômetros de platô coberto de gelo, a uma altitude de 363 metros, sem maiores dificuldades.

A reflexão e o raciocínio revelam a inteligência em seu nível mais alto. E através da reflexão e do raciocínio que o líder penetra no âmago do mais profundo problema. Por elas, ele descobre posturas falsas, segredos escondidos, e impõe respeito. São elas que, devido à sua incisiva penetração, fazem de um homem um líder. Elas atingem o ponto mais alto da compreensão e abrem as portas para a realização pessoal.
...
A energia de um líder é demonstrada através da dedicação à tarefa e sua persistência nela. Foi Thomas Edison que disse que o gênio se constitui em um por cento de inspiração e noventa e nove por cento de transpiração. Em 1878, ele predisse que seria capaz de usar a eletricidade para iluminar casas e escritórios. “Quando ficarem sabendo como consegui realizar meu objetivo, todos vão se perguntar por que não haviam pensado naquilo”, disse ele. O mais espantoso a respeito dessa declaração é que Edison ainda não tinha inventado a lâmpada elétrica. E que tinha muitos obstáculos a superar antes de atingir sua meta, mas cria que podería fazêlo. Ele tinha dedicação e persistência. Teve que realizar milhares de experiências, por exemplo, para chegar ao material certo para o filamento da lâmpada. Testou todo tipo de substância imaginável — platina, fio de barba, negro-de-fumo, e várias outras — até que obteve sucesso com o fio de algodão carbonizado. Com sua dedicação e incrível persistência, Edison deu ao mundo a lâmpada elétrica que, por ocasião de sua invenção, foi considerada como a oitava maravilha do mundo.
...
Pouco antes de Bob Pierce1 falecer, ele me disse o seguinte:

“Creio sinceramente que Deus pretendia que outro homem fizesse o que, no fim, eu acabei fazendo.”

E mencionou o nome do outro homem.

“Mas”, continuou, “ele não quis fazer a entrega total necessária para realizar a obra. Era preguiçoso demais para liderar. E, assim, Deus me tomou, apesar de ter menos dons, menos estudo e menos atrativos pessoais, e me usou. Eu me dispus a dedicar-me totalmente à execução daquela meta.”

Qualquer um que viajar pela Ásia logo notará as grandes pegadas deixadas por esse homem. E impossível descrever a liderança de Pierce sem mencionar sua energia. Quando fez sua última viagem missionária ao redor do mundo já sofria de câncer em estado adiantado. Foi confinado a uma cadeira de rodas. E até ao fim Bob manteve seu intento original de socorrer os necessitados e fazê-lo como um testemunho do amor e da salvação de Cristo.
...
Francisco Xavier abandonou uma vida de riqueza e uma alta posição social e saiu pelo mundo com a mensagem de redenção através de Cristo Jesus. Foi preciso muita energia para trabalhar vinte e uma horas por dia, para aprender a pregar em vinte línguas em apenas dez anos, para conseguir lugar num navio de transporte de tropas e, mais tarde, em barcos de piratas, navegando pelos mares em embarcações de pouca segurança. Foi preciso muita energia para dormir em tendas de beduí-nos, para atravessar os ardentes desertos e as montanhas geladas da Ásia. Xavier precisou de muita energia para desafiar a morte sob todas as formas, apertar as mãos de todas as doenças e enfermidades, suportar as agonias da fome e os horrores da sede, após um horrível naufrágio e amarga perseguição. Mas nenhum outro cristão teve maior impacto no Japão, por exemplo, do que Francisco Xavier.

Essa energia demonstrada por Francisco Xavier — ou por Napoleão, ou Florence Nightingale, ou João Wesleyou Ernest Watson — no exercício de sua liderança é um desafio para nós. A liderança exige vitalidade física, acuidade mental, muito trabalho, dedicação à tarefa, persistência e atenção aos detalhes.

E verdade que algumas pessoa por natureza possuem mais energia que outras. Não obstante, todos podemos aumentar nosso nível de energia. Todo líder deve querer elevar seu nível de energia ao ponto máximo. Não precisamos sentir-nos preguiçosos. Podemos ter mais energias do que temos atualmente.
...
Alimentar-se corretamente não implica apenas em seguir um regime alimentar durante uma semana ou duas. E mudar o modo de pensar acerca do alimento — principalmente se os alimentos industrializados estão disponíveis. Precisamos estar constantemente côncios do que nos faz bem e do que não faz, pois podemos, inconscientemente, ingerir alimentos que não fazem bem. Por exemplo, alguns alimentos industrializados e de refeições rápidas contêm muito açúcar e sal. A cafeína é encontrada não somente no café e no chá, mas no chocolate e em muitos refrigerantes feitos da semente da cola (essa a razão por que já existem refrigerantes de cola descafeinados).
...
Bob Pierce foi o fundador da World Vision, organização de assistência a crianças e comunidades carentes, conhecida no Brasil como Visão Mundial. N. T.$conteudo$,
  ...
  -- 11. O Princípio do Poder da Persistência
  update public.aulas
  set conteudo =
$conteudo$0 Princípio do PODER DE PERSISTÊNCIA No fim da década de 1960, fui convidado para dirigir uma campanha evangelística em Lisboa, Portugal. Era uma oportunidade maravilhosa pois, pela primeira vez na história de Portugal, que é 99 por cento católico, um ministro protestante era convidado para dirigir reuniões em edifícios públicos.
...
Quando pastoreava, eu não tinha querido afastar-me de casa. Contudo, sabia que Deus queria que eu fosse evangelista. Teria sido fácil desistir em face da oposição da “Empresa Evangelística” — oposição que não com-preendi na ocasião e continuo a não compreender agora. A oposição que recebi em Portugal não foi um incidente isolado. Já havia recebido oposição deles antes. Pouco depois de haver iniciado meu ministério evangelístico, a liderança daquela empresa tentou sufocá-lo conseguindo que alguns contratos nossos fossem cancelados. Houve casos em que usaram a tática do ataque direto como quando bombardearam os planos para uma campanha que pensava realizar em Honolulu, atingindo toda a cidade, a pedido dos pastores de lá.
...
Essa oposição ativa durou muitos anos. A “Empresa Evangelística” parecia decidida a destruir nosso ministério. Pedi a Deus a graça de permanecer fiel a ele e à visão que ele me havia dado. Durante quinze anos tentei por todos os meios conseguir uma entrevista com o cabeça da empresa. Ele se recusou a conversar comigo. Eu contribuira para a organização desde os tempos de colégio. Orava por ela diariamente. Meu filho, Johnny, orava com grande fervor pelo chefe da empresa. Jamais lhe contei esses fatos porque não queria que ele perdesse a confiança nas pessoas envolvidas. A^yJa hoje continuo a orar por esse homem e pela organização.
...
A implacável oposição da “Empresa Evangelística” constituiu uma indescritível provação para nós. Nos primeiros anos, gastei todas as minhas economias, vendi meu carro, e fiz empréstimos para manter o ministério de pé. Isso foi necessário porque, cada vez que a “Empresa Evangelística” conseguia que nossas reuniões fossem canceladas, perdíamos todo o dinheiro que havíamos empregado na preparação da campanha — dinheiro que, normalmente, seria reembolsado pelo comitê financeiro da campanha após a realização dela. Em quatro ocasiões estivemos à beira da bancarrota, e quase fomos obrigados a encerrar tudo. É possível que a liderança da “Empresa Evangelística” acreditasse, sinceramente, que não estávamos qualificados para trabalhar no campo da evange-lização. No entanto, durante mais de uma década, eles plagiaram nosso material (plagiaram um artigo de revista copiando-o quase palavra por palavra), e, naturalmente, o plágio é a mais genuína forma de elogio.
...
As dificuldades existem. Não nos enganemos pensando que não existem. Todo líder sofre pressões e problemas que podem levá-lo a desistir. A oposição que a “Empresa Evangelística” me faz, levou-me a questionar a direção de Deus bem como minha capacidade para cumprir a visão que ele me dera.
...
• Nasceu o primeiro filho de um casal jovem. Ele é mongolóide.
...
Mas não foi a morte de Policarpo que o levou à sua posição de proeminência; foi sua liderança. E sua liderança foi caracterizada por um indiscutível poder de persistênca. Ele permaneceu fiel ao seu chamado e ao seu Senhor até ao momento em que as chamas lamberam seu corpo, e ele exalou o último suspiro.
...
Ou montanhas que acredita ser inaccessíveis?

Deus é especialista em feitos que achamos impossíveis; Faz coisas que outros pensam irrealizáveis.”
...
O Dr. Han Kyung Chik está na igreja ao romper do dia, todos os dias do ano, para seu período de oração. Durante o dia, sempre que começa uma nova tarefa, ou uma nova reunião, ele curva tranquilamente a cabeça em oração sem ostentação, sem constrangimento, sem rudeza. Se vai visitar uma pessoa, por exemplo, pára um momento, logo após o aperto de mão, para, silenciosamente, consagrar o encontro ao Senhor. Não importa se a pessoa é um pregador do evangelho ou um chefe de Estado. O Dr. Han vive em comunhão com Deus. E Deus lhe tem concedido poder de persistência.

O PODER DE PERSISTÊNCIA GARANTE O SUCESSO

O líder sempre enfrenta problemas e desencoraja-mentos, mas pode vencê-los com o poder de persistência. Parece que muitos dos famosos líderes do mundo tiveram que enfrentar grandes dificuldades e desencorajamentos para tornar realidade sua visão.
...
Muitos líderes, em certas ocasiões, ficam em dúvida se deveriam ou não desistir. Quando esses momentos ocorrem, eles podem fortalecer seu poder de persistência recordando sua visão, focalizando suas metas, visualizando sua metas como se já tivessem sido atingidas, relaxando, lendo biografias e vivendo em comunhão com Deus.

O poder de persistência garante o sucesso. O líder enfrentará problemas e desencorajamentos, mas poderá vencê-lo com o poder de persistência.$conteudo$,
      audio_leitura_url = null
...
— E como um judeu, amável, baixo, um tanto gordo. Não é o que a gente chamaria de bonitão. Não é de forma alguma um tipo imponente. Nem sua fala chega a ser marcante.

— Então fico perguntando a mim mesmo qual seria o segredo do seu sucesso.

— A câmara pegou os olhos dele, disse ela. Se você visse os olhos dele poderia compreender seu sucesso. Havia uma expressão de autoridade que é difícil de descrever. Era indefinível, mas vê-se que ele a possui.

Depois dessa ocasião, encontrei-me com Ben Feldman em duas oportunidades. Ele é educado e respeitável. Embora não impressione fisicamente, possui uma autoridade que quase derruba a gente. Não que ele tenha uma personalidade agressiva, não. E calmo, moderado e fala com suavidade. Creio que Ben Feldman poderia ser deixado em qualquer lugar do mundo, completamente desconhecido, e, dentro em pouco, estaria no alto. Ele tem essa espécie de autoridade. E um líder nato.
...
Ter autoridade interior não significa que a pessoa se acha melhor do que os outros. E, mais, exatamente, uma convicção de que pode influenciar os membros do seu grupo para buscarem atingir as metas de permanente benefício. Não é orgulho, mas a crença de que sua visão, suas ideias e sua liderança beneficiarão o grupo. Todo líder, em algum momento de sua vida, descobre que é realmente capaz de influenciar outros. As pessoas agem e se modificam por causa do que ele diz e faz. E assim que ele percebe que possui autoridade interior.
...
Nicodemos era uma das setenta pessoas mais importantes do povo judeu na Judeia. Como membro do Siné-drio, ajudava a governar a nação. Religiosamente, ele era inigualável. Sabia de cor 400 leis cerimoniais. Jejua-va dois dias por semana e orava quatro vezes por dia. Em contraste, Jesus não tinha posição, nem status. Indubitavelmente, Nicodemos era mais velho que Jesus. E, no entanto, quando os dois se encontraram, Jesus foi o líder inconteste. Logo no início do encontro deles, Nicodemos dirigiu-se a Jesus chamando-o de “Rabi”, que significa “Mestre”. Jesus possuía uma autoridade interior que ninguém negava, nem mesmo seus caluniadores.
...
Em seu livro, Power: How to Get it, How to use it (O poder: como consegui-lo, como usá-lo), Michael Korda descreve os símbolos que constituem a autoridade exterior no mundo financeiro americano.39Uma limusine é um desses símbolos. “As limusines alugadas são menos prestigiosas do que as particulares; um Rolls Royce mostra mais prestígio do que os Cadillacs; mas nada se iguala a um Mercedes 600 com o cromo pintado de preto e os vidros traseiros escurecidos para impedir que o ocupante seja visto.” Um telefone na limusine é um símbolo padrão de autoridade, e pode-se até adquirir uma antena de telefone de modo a que os outros pensem que se tem um telefone no carro, embora ela não esteja de fato ligada a um aparelho.
...
O líder que se espelha em Cristo procura desenvolver sua autoridade interior e não contar com a exterior. Entretanto, se ele estiver consciente de sua liderança (ver capítulo 13) e a desenvolver pelo cultivo da autoridade interior, estará cônscio, também, dos elementos que são considerados símbolos e manipulações da autoridade exterior na sua situação. Embora ele subordine a autoridade exterior à interior, utiliza a primeira de forma sábia.

DESENVOLVENDO A AUTORIDADE INTERIOR

Nós temos, dentro de nós, uma autoridade interior. Quem pretende ser líder, mas não exibe essa autoridade, seja por não exercitá-la ou por não ter auto-estima, deve tomar providências para cultivá-la.
...
E vital que desenvolvamos uma forte crença em nossa capacidade de alcançar sucesso. E se praticarmos os doze princípios da liderança, alcançaremos sucesso, e nossa autoridade interior se desenvolverá.
...
Sem nenhum dos símbolos de autoridade exterior que a maioria das pessoas acha tão necessários, Madre Teresa fundou uma ordem de dedicadas freiras e irmãos que trabalham, atualmente, em cinco continentes. Tornou-se um símbolo internacional de bondade e é honrada por reis, papas, jornalistas, bem como pelos ricos e poderosos deste mundo. Em 1979, recebeu o Prêmio Nobel da Paz porque “os mais solitários, os mais infelizes, e os moribundos...receberam dela compaixão sem paternalismos.” Os 192. dólares do prêmio foram destinados, por ela, para a construção de um leprosário na índia.

Nascida em Skopje, Iugoslávia, em 1910, filha de um merceeiro albanês, Agnes Conxha Bojaxhiu (nome de nascimento de Madre Tereza) foi chamada para ser freira aos doze anos de idade. Ela se tornou uma das “irmãs de Loreto” e foi ser missionária na índia. Em 1946 recebeu um segundo chamado, desta vez para deixar o convento e ir viver entre os pobres para ajudá-los.
...
A autoridade interior não tem nada a ver com as características físicas ou atos de uma pessoa, nem com sua riqueza, sua posição social ou seu status. Nem é decorrente do seu sucesso. A autoridade interior é, mais precisamente, a convicção de que podemos influenciar as pessoas de nosso grupo para buscarem atingir as metas de permanente benefício. Quem possui autoridade interior é alguém com um forte senso de auto-estima.

A autoridade exterior deriva sua influência não da força e capacidade pessoal, com") õçorre com a interior, mas dos sinais, símbolos e manipi-T.íções externos. É uma autoridade que pode ser retirada de quem a possui. Além disso, é imediatamente reconhecível para aqueles que sabem “identificar” os sinais.
...
Todos os princípios da liderança são importantes, mas nem todos são absolutamente essenciais. Cultivar o princípio de autoridade o é. É essencial que o líder possua autoridade interior, demonstre-a aos outros e use em seu benefício os símbolos da autoridade exterior que acompanham sua posição.$conteudo$,
      audio_leitura_url = null
  where curso_id = v_curso_id and ordem = 12;
  -- 13. O Princípio da Conscientização
  update public.aulas
  set conteudo =
$conteudo$Estar consciente é a base da excelência. Isso se aplica não somente em relação aos líderes, mas também aos atletas, músicos, oradores, comerciantes e escritores — aplica-se em todas as áreas da vida. Para destacar-se, uma pessoa deve estar cônscia dos elementos que contribuem para um desempenho excelente bem como deve avaliar constantemente seu próprio desempenho em relação ao padrão de excelência que estabeleceu para si mesma. Há algumas pessoas que são líderes “naturais” ou atletas “naturais” ou oradores “naturais”. Esses podem sair-se bem seguindo seu talento e instinto naturais. E podem intensificar sua habilidade por meio do treinamento. Mas, treinem ou não, é essencial que estejam conscientes de suas habilidades.
...
Podería parecer que o moço possui aptidão para liderança. Não obstante, essa única ocasião não é garantia de que ele teria uma sólida e contínua eficiência na liderança. Para ele ser um líder eficiente, deve estar consciente de sua liderança e, com disciplina, cultivar os princípios de liderança.

A importância de estar consciente está no fato de que isso é a base da auto-imagem que o líder deve ter, para ser eficiente. Ele não pode confundir fraqueza com humildade, relutância com esperar no Senhor, volunta-riedade com individualidade, excessiva socialização com eficiente sociabilidade. A consciência da sua tarefa de liderança, do que é liderança, e de como deve exercê-la, sustenta a disciplina de que o líder precisa para ter eficiência. As vezes, um líder experimentará uma solidão que clama pela companhia de outros, uma fadiga que clama por compreensão e riscos de responsabilidades que soam como sirenas de medo. Mas se estiver consciente da tarefa de sua liderança isso reforçará sua dedicação à missão. Esse compromisso é essencial para sustentar a severa disciplina necessária a uma liderança eficiente. Sem essas duas coisas, consciência e dedicação, nossa liderança entrará em colapso.
...
Será muito proveitoso revermos o que já discutimos quanto aos princípios de liderança, pois o líder deve estar consciente não apenas do seu papel na liderança e do significado dela, mas também dos princípios que a regem. Esses princípios são os elementos essenciais de uma liderança eficiente. Assim como um escritor tem que estar constantemente consciente das regras aa gramática enquanto está escrevendo, o líder precisa estar sempre consciente das diretrizes básicas para um eficiente estabelecimento de metas ou da necessidade de mostrar energia quando está liderando.
...
Uma boa consciência dos fatos é um ingrediente essencial no desenvolvimento do autocontrole. É que o sucesso na liderança exige autocontrole, embora esse sucesso torne difícil a prática do autocontrole. Portanto, o líder só terá autocontrole se estiver constantemente cônscio da necessidade de praticar os passos para obtê-lo. Nossa tendência natural é reverter a um estado de falta de disciplina e controle. O autocontrole se desenvolve através da dependência de Deus, de uma vida de disciplina, da prática de tomar decisões antecipadamente, da gratidão pela adversidade, do domínio do temperamento, do controle dos pensamentos e do controle exercido pelo Espírito Santo.
...
O líder precisa estar cônscio da importância da comunicação eficiente. Cada vez que fala ou escreve alguma mensagem, deve estar consciente de que é preciso que haja entendimento dela, e não apenas a enunciação das palavras.

O líder deve habituar-se a avaliar aqueles a quem se dirige. Precisa descobrir suas características e atitudes antes de começar a falar-lhes ou escrever-lhes. Deve estar cônscio delas.

Além disso, ele precisa selecionar a meta certa de comunicação. Só poderá determinála depois que fizer a avaliação do auditório e definir o objetivo de sua comunicação. Assim deve estar sempre consciente de sua meta enquanto fala ou escreve sua mensagem.
...
Há dois tipos de pessoas no mundo: as que investem e as que retêm. Os investidores, por natureza, praticam o princípio de investimento; os retentores tentam entesou-rar tudo que têm ou o gastam em seu próprio interesse. Afinal os retentores perdem. Perdem a disposição, os amigos, a saúde e o respeito. E os investidores ganham.
...
Podería parecer que James Howard tinha fracassado. Mas, a partir do problema de seu esgotamento nervoso nasceu sua maior oportunidade. Ele passou a estudar-se sem pressa. Escreveu sua visão e missão e uma nova série de metas. Analisou quatro tipos de negócios de corretagem que podería experimentar: fazenda e madeira, casas solares, imóveis e pequenos negócios. Daí nasceu a Serviços de Negócios Agrários, a mais bem-sucedida microempresa de corretagem dos Estados Unidos. James Howard, cuidadosa e sistematicamente, transformara seu obstáculo em oportunidade.
...
O líder que compreende o princípio da energia é cônscio da importância de demonstrar energia diante de seus seguidores. Eles não poderão ser mais entusiastas ou mais enérgicos do que o próprio líder. E este sabe que a organização não estará acima do nível que ele próprio mostra. Por isso, ele cultiva cuidadosamente o princípio de energia em si próprio.
...
A autoridade exige conscientização. Para um líder exercer o princípio de autoridade tem que estar consciente do que está fazendo e do por que o faz.
...
(7) O princípio do investimento. É possível alguém beneficiar-se do princípio do investimento sem ter essa conscientização, mas isso seria o resultado de uma ação casual. O líder eficiente há de querer planejar seu uso do investimento para maximizar os benefícios dele para seu grupo. J (8) O princípio da oportunidade. Nossas maiores oportunidades nos aparecem habilmente disfarçadas em problemas insuperáveis. Estando plenamente consciente da situação, o líder pode condicionar-se a ver oportunidades em toda parte.
...
(11) O princípio da autoridade. O líder só pode exercer o princípio de autoridade se estiver consciente do que está fazendo e porquê. Ele deve estar consciente tanto da sua autoridade interior quanto da exterior.
...
O líder também deve estar consciente de que seus recursos provêm de Deus. Ele compreende que seu poder vem do Senhor.$conteudo$,
      audio_leitura_url = null
