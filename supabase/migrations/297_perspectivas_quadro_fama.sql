-- 297_perspectivas_quadro_fama.sql
-- O quadro "A fama de Deus entre as nações", da p. 3 do guia da Lição 2, estava
-- achatado em texto corrido: as três colunas ficaram intercaladas numa mesma
-- linha ("...o rei do Gênesis 14.20: ... que entregou os seus "Deus altíssimo""),
-- e os espaços que o aluno deve preencher sumiram. Não dava para usar.
--
-- Vira figura. O guia manda "preencher os espaços da última coluna do exercício
-- abaixo" — sem a imagem, o exercício não existe.
--
-- Primeiro de uma série: a varredura de figuras nos 15 arquivos-fonte está em
-- curso e outros quadros e diagramas devem seguir o mesmo caminho.

begin;

update aulas set conteudo = 'A maioria de nós estuda a Bíblia abordando uma história de cada vez. Lições geralmente são aplicadas unicamente às nossas questões pessoais. Por causa disso, pode ser que pensemos, erradamente, que a Bíblia seja uma coleção de histórias desconectadas entre si, sem nenhum propósito maior e integrador. Além disso, ainda podemos estar errados — de um modo bastante egoísta — em pensar que a Bíblia só diz respeito às nossas vidas pessoais. A realidade é que ela diz muito mais sobre Deus do que sobre nós mesmos. Com Deus no centro, a Bíblia pode ser entendida como uma só grande narrativa e não como uma coleção de histórias desunidas e de afirmações antigas. É uma história que percorre cada parte das Escrituras — e ainda está se desdobrando até hoje.
...
[figura] /figuras/perspectivas/fama-de-deus-entre-as-nacoes.png | A fama de Deus entre as nações — quadro do guia, com as colunas “O nome de Deus” e “A fama de Deus” e os espaços a preencher
